# coterm terminfo overlay

coterm ships patched `xterm-ghostty` and `xterm-256color` terminfo entries so
...
coterm while preserving Ghostty's truecolor capabilities.
