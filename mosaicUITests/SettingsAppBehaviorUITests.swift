...
///     does not have (MOSAIC_UI_TEST_MODE skips session restore).
...
///   - Open Supported Files / Open Markdown (openSupportedFilesInMosaic,
///     openMarkdownInMosaicViewer): effect triggers on Cmd-click of a file
