...
export const agentReadablePages = [
  { path: "/", title: "Home" },
  { path: "/ios", title: "coterm iOS" },
  { path: "/blog", title: "Blog" },
  { path: "/blog/coterm-home", title: "coterm home" },
  { path: "/blog/coterm-history", title: "coterm history" },
  { path: "/blog/coterm-finder", title: "Introducing Coterm Finder" },
  { path: "/blog/coterm-vault", title: "coterm Vault" },
  { path: "/blog/passkey-auth", title: "Passkey auth in the Coterm browser" },
  { path: "/blog/task-manager", title: "Task Manager in Coterm" },
  { path: "/blog/markdown-viewer", title: "A better markdown viewer in Coterm" },
  { path: "/blog/unread-shortcuts", title: "Unread workspace shortcuts in Coterm" },
  { path: "/blog/session-restore", title: "Session restore in Coterm" },
  { path: "/blog/coterm-ssh", title: "Coterm SSH" },
  {
    path: "/blog/coterm-claude-teams",
    title: "Claude Code teammate agents as native coterm panes",
  },
  {
    path: "/blog/coterm-omo",
    title: "oh-my-openagent subagents as native coterm panes",
  },
  { path: "/blog/gpl", title: "coterm is now GPL" },
  { path: "/blog/cmd-shift-u", title: "Cmd+Shift+U" },
  { path: "/blog/zen-of-coterm", title: "The Zen of Coterm" },
  { path: "/blog/show-hn-launch", title: "Launching coterm on Show HN" },
  { path: "/blog/introducing-coterm", title: "Introducing Coterm" },
...
export function buildLlmsText(origin: string): string {
  const lines = [
    ...
    "## Programmable",
    "",
    "coterm is designed to be driven by scripts and agents, not just used by hand. Every command is available through both a `coterm` CLI and a Unix socket, so anything an agent has in its PATH can control the running app:",
    "",
    ...
    "- Hooks: run your own commands on coterm events to wire it into other tools and notification pipelines.",
