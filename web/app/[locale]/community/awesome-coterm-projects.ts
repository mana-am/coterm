export type AwesomeCotermProject = {
  name: string;
  url: string;
  agent?: string;
...
export const awesomeCotermSourceUrl = "https://github.com/emergent-inc/awesome-coterm";
export const awesomeCotermCuratedProjectRows = 150;

export const awesomeCotermCategoryOrder = [
...
export const awesomeCotermProjects = [
  {
  ...
  {
    "name": "emergent-inc/coterm-skills",
    "url": "https://github.com/emergent-inc/coterm-skills",
    "agent": "Multi",
    "descriptionKey": "p077",
    "language": "Python",
    "categories": [
  ...
  {
    "name": "emergent-inc/homebrew-coterm",
    "url": "https://github.com/emergent-inc/homebrew-coterm",
    "descriptionKey": "p078",
    "language": "Ruby",
    "categories": [
      "Build & Distribution"
...
] as const satisfies readonly AwesomeCotermProject[];
