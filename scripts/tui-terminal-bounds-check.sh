...
INTERVAL="${COTERM_BOUNDS_TUI_INTERVAL:-1}"
USE_ALT_SCREEN="${COTERM_BOUNDS_TUI_ALT_SCREEN:-1}"
HAVE_ALT_SCREEN=0
NEEDS_DRAW=1
...
draw_frame() {
  ...
  now="$(date '+%H:%M:%S')"
  put_centered_line_text 3 "COTERM BOUNDS CHECK"
