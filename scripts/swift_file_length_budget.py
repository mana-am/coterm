#!/usr/bin/env python3
"""Check coterm-owned Swift file lengths against a checked-in budget."""
...
DEFAULT_ROOTS = ("Sources", "CLI", "Packages", "cotermTests", "cotermUITests")
...
def write_budget(path: pathlib.Path, budget: FileLengthBudget) -> None:
    ...
    with path.open("w", encoding="utf-8") as handle:
        handle.write("# coterm-owned Swift file length budget.\n")
...
def main(argv: list[str]) -> int:
    ...
    print_file_summary("All scanned coterm-owned Swift files", file_lengths)
