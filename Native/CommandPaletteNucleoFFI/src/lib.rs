...
#[repr(C)]
pub struct CotermNucleoCandidateSpan {
    title_offset: usize,
    title_len: usize,
    search_offset: usize,
    search_len: usize,
...
#[no_mangle]
pub extern "C" fn coterm_nucleo_ffi_version() -> u32 {
    2
}

#[no_mangle]
pub unsafe extern "C" fn coterm_nucleo_index_create(
    blob_ptr: *const u8,
    blob_len: usize,
    spans_ptr: *const CotermNucleoCandidateSpan,
    span_count: usize,
) -> *mut CotermNucleoIndex {
    ...
    Box::into_raw(Box::new(CotermNucleoIndex { candidates }))
}

#[no_mangle]
pub unsafe extern "C" fn coterm_nucleo_index_destroy(index: *mut CotermNucleoIndex) {
    if !index.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn coterm_nucleo_index_search(
    index: *mut CotermNucleoIndex,
    query_ptr: *const u8,
    query_len: usize,
    result_limit: usize,
    out_matches: *mut CotermNucleoMatch,
    out_capacity: usize,
    out_count: *mut usize,
) -> i32 {
    coterm_nucleo_index_search_impl(
        index,
        query_ptr,
        query_len,
        result_limit,
...
#[no_mangle]
pub unsafe extern "C" fn coterm_nucleo_index_search_with_boosts(
    index: *mut CotermNucleoIndex,
    query_ptr: *const u8,
    query_len: usize,
    result_limit: usize,
...
unsafe fn coterm_nucleo_index_search_impl(
    index: *mut CotermNucleoIndex,
    query_ptr: *const u8,
    query_len: usize,
    result_limit: usize,
    ...
    *out_count = 0;
    ...
    let output: Vec<CotermNucleoMatch>;
...
fn sorted_output(best_matches: BinaryHeap<WorstFirstScoredCandidate>) -> Vec<CotermNucleoMatch> {
    ...
    scored
        .into_iter()
        .map(|candidate| CotermNucleoMatch {
