...
/// `Packages/macOS/CotermSettingsUI/.../Sections/WorkspaceColorsSection.swift`
/// and `Packages/macOS/CotermSettings/.../Keys/WorkspaceColorsCatalogSection.swift`):
///
...
//   coterm.json, neither reachable from XCUITest without a seam. Verifying
