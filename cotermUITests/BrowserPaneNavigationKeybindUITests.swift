...
final class BrowserPaneNavigationKeybindUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/coterm-ui-test-goto-split-\(UUID().uuidString).json"
        try? FileManager.default.removeItem(atPath: dataPath)
        diagnosticsPath = "/tmp/coterm-ui-test-goto-split-\(UUID().uuidString).diagnostics.json"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocused() {
        ...
        app.launchEnvironment["COTERM_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["COTERM_UI_TEST_FOCUS_SHORTCUTS"] = "1"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocusedUsingGhosttyConfigKeybind() {
        ...
        app.launchEnvironment["COTERM_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        configureSocketLaunch(app)
        app.launchEnvironment["COTERM_UI_TEST_GOTO_SPLIT_USE_GHOSTTY_CONFIG"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testEscapeRestoresFocusedPageInputAfterCmdL() {
        ...
        app.launchEnvironment["COTERM_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["COTERM_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["COTERM_UI_TEST_GOTO_SPLIT_INPUT_SETUP"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testTerminalSplitAfterBrowserSplitFocusesCreatedTerminal() {
        let app = XCUIApplication()
        configureSocketLaunch(app)
        app.launchEnvironment["COTERM_UI_TEST_GOTO_SPLIT_RECORD_ONLY"] = "1"
        app.launchEnvironment["COTERM_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        launchAndEnsureForeground(app)
        XCTAssertTrue(waitForSocketPong(timeout: 12.0), socketReadinessFailureMessage())
