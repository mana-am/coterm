...
final class SidebarPullRequestInteractivityUITests: XCTestCase {
    ...
    private var pullRequestURL: String {
        "https://github.com/emergent-inc/coterm/pull/\(pullRequestNumber)"
    }

    override func setUp() {
        super.setUp()
        continueAfterFailure = false
        socketPath = "/tmp/coterm-ui-test-sidebar-pr-\(UUID().uuidString).sock"
    ...
    private func assertSidebarPullRequestClickFallsThrough(
        ...
        app.launchArguments += [
            ...
            "-browserOpenSidebarPullRequestLinksInCotermBrowser", "true",
        ]
