...
final class AutomationSocketUITests: XCTestCase {
    ...
    private let defaultsDomain = "coterm.com.emergent.app.debug"
    ...
    override func setUp() {
        ...
        diagnosticsPath = "/tmp/coterm-ui-test-automation-socket-\(UUID().uuidString).json"
    ...
    func testSocketToggleDisablesAndEnables() {
        let app = configuredApp(mode: "cotermOnly")
        app.launch()
        XCTAssertTrue(
    ...
    private func makeSkillFixtureRoot(skillNames: [String]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-ui-textbox-skills-\(UUID().uuidString)", isDirectory: true)
