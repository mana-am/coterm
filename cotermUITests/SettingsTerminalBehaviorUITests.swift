...
/// (`Sources/cotermApp.swift`, the `Settings…` window) and in the
/// migrated `CotermSettingsUI.TerminalSection`:
...
final class SettingsTerminalBehaviorUITests: SettingsUITestCase {
    ...
    private enum Subtitle {
        ...
        static let copyOff = "coterm does not add system-clipboard copy on selection"
