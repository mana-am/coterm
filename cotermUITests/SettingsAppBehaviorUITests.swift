...
///     does not have (COTERM_UI_TEST_MODE skips session restore).
...
///   - Open Supported Files / Open Markdown (openSupportedFilesInCoterm,
///     openMarkdownInCotermViewer): effect triggers on Cmd-click of a file
