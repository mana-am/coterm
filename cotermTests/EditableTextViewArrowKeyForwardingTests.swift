...
/// Regression coverage for https://github.com/emergent-inc/coterm/issues/5227.
///
/// In a coterm window every keyDown is funneled through the swizzled
...
struct EditableTextViewArrowKeyForwardingTests {
    ...
    func doesNotStealCommandOptionArrowFromPaneFocusShortcut(keyCode: UInt16) {
        // Cmd+Option+Arrow is reserved for coterm pane-focus shortcuts and must
