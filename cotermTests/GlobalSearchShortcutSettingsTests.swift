...
final class GlobalSearchShortcutSettingsTests: XCTestCase {
    ...
    override func setUp() {
        ...
        KeyboardShortcutSettings.settingsFileStore = KeyboardShortcutSettingsFileStore(
            primaryPath: FileManager.default.temporaryDirectory
                .appendingPathComponent("coterm-global-search-shortcuts-\(UUID().uuidString).json")
                .path,
            fallbackPath: nil,
    ...
    func testSettingsFileStoreParsesGlobalSearchShortcut() throws {
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-global-search-settings-\(UUID().uuidString)", isDirectory: true)
    ...
    func testSettingsFileStoreParsesPackageObjectFormGlobalSearchShortcut() throws {
        // Regression for https://github.com/emergent-inc/coterm/issues/5137.
        // The in-app Settings UI (CotermSettings package) persists every
        // shortcut rebinding to coterm.json under `shortcuts.bindings.<action>`
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-global-search-object-settings-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
    ...
    func testSettingsFileStoreParsesPackageObjectFormChordShortcut() throws {
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-chord-object-settings-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
    ...
    func testSettingsFileStoreParsesPackageObjectFormUnboundShortcut() throws {
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-unbound-object-settings-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
    ...
    func testSettingsFileStoreRejectsObjectFormChordWithMalformedSecondStroke() throws {
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-bad-chord-object-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
    ...
    func testSettingsFileStoreRejectsObjectFormBareKeyForModifierRequiringAction() throws {
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-bare-object-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
    ...
    func testSettingsFileStoreRejectsGlobalSearchChordBinding() throws {
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-global-search-invalid-settings-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
