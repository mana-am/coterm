...
/// Regression coverage for remote-tmux (`coterm ssh-tmux`) new-tab cwd inheritance.
///
/// In local coterm a new tab inherits the active tab's working directory; the
...
/// focused tab's directory. coterm appends that directory onto the placement
