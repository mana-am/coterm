...
/// Regression coverage for https://github.com/emergent-inc/coterm/issues/4529.
///
/// PR https://github.com/emergent-inc/coterm/pull/4437 migrated
/// `CotermTaskManagerModel` to `@Observable` and the Task Manager view body
...
/// https://github.com/emergent-inc/coterm/issues/2586): any view rendered
...
final class TaskManagerViewSnapshotBoundaryTests: XCTestCase {
    func testTaskManagerRowViewEqualityIgnoresClosureIdentity() {
        ...
        let leftView = CotermTaskManagerRowView(
            row: row,
            onViewWorkspace: {},
            onViewTerminal: {},
            onKillProcess: {},
        ...
        let rightView = CotermTaskManagerRowView(
            row: row,
            onViewWorkspace: { _ = 1 },
            onViewTerminal: { _ = 2 },
            onKillProcess: { _ = 3 },
    ...
    func testTaskManagerRowViewEqualityDetectsRowChanges() {
        ...
        let left = CotermTaskManagerRowView(
            row: baseRow,
            onViewWorkspace: {},
            onViewTerminal: {},
            onKillProcess: {},
        ...
        let right = CotermTaskManagerRowView(
            row: bumpedRow,
            onViewWorkspace: {},
            onViewTerminal: {},
            onKillProcess: {},
    ...
    private static func makeRow(memoryBytes: Int64 = 1_024) -> CotermTaskManagerRow {
