...
import struct CotermSettings.QuitConfirmationStore
import struct CotermSettings.CommandPaletteSettingsStore
import enum CotermSettings.ConfirmQuitMode
import struct CotermSettings.SettingCatalog
import struct CotermSettings.UserDefaultsSettingsClient
...
final class CommandPaletteRenameSelectionSettingsTests: XCTestCase {
    private let suiteName = "coterm.tests.commandPaletteRenameSelection.\(UUID().uuidString)"
...
final class RightSidebarModeShortcutHintTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        KeyboardShortcutSettings.settingsFileStore = KeyboardShortcutSettingsFileStore(
            primaryPath: directoryURL.appendingPathComponent("coterm.json", isDirectory: false).path,
            fallbackPath: nil,
            startWatching: false
        )
    ...
    func testAlwaysShowHintsIsOnlyEnabledForUITests() {
        ...
        XCTAssertTrue(
            ShortcutHintDebugSettings(
                environment: ["COTERM_UI_TEST_SHORTCUT_HINTS_ALWAYS_SHOW": "1"]
            ).alwaysShowHints
        )
    }
...
final class BuildFlavorTests: XCTestCase {
    func testDetectsDevFromBundleName() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "Coterm DEV noqdlg", bundleIdentifier: "coterm.com.emergent.app"),
            .dev
        )
    }
    ...
    func testDetectsDevBeforeTagTextCanLookNightly() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "Coterm DEV nightly", bundleIdentifier: "coterm.com.emergent.app"),
            .dev
        )
    }
    ...
    func testDetectsNightlyFromBundleIdentifier() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "coterm", bundleIdentifier: "coterm.com.emergent.app.nightly"),
            .nightly
        )
    }
    ...
    func testDetectsStableByDefault() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "coterm", bundleIdentifier: "coterm.com.emergent.app"),
            .stable
        )
    }
}
