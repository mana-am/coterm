...
extension CotermCLIErrorOutputRegressionTests {
    func XCTAssertFalse(
    ...
    final class CotermTestExpectation {
    ...
    func expectation(description: String) -> CotermTestExpectation {
        CotermTestExpectation(description: description)
    }

    func wait(for expectations: [CotermTestExpectation], timeout: TimeInterval) {
