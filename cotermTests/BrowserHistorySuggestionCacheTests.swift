...
@Suite struct BrowserHistorySuggestionCacheTests {
    private func makeStore() -> (store: BrowserHistoryStore, fileURL: URL) {
        let fileURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-history-suggest-\(UUID().uuidString).json")
    ...
    @Test func suggestionsMatchHostAndTitleAfterCaching() {
        ...
        store.recordVisit(url: URL(string: "https://github.com/emergent-inc/coterm/issues"), title: "coterm issues")
        ...
        #expect(results.contains("https://github.com/emergent-inc/coterm/issues"))
