...
// compiled into both the `coterm-cli` target and this test target — so the pure
// classification decision can be unit-tested directly, without `@testable`
// importing the `coterm_cli` executable module (whose symbols the app-hosted
...
///
/// https://github.com/emergent-inc/coterm/issues/4985
...
struct FeedEventClassificationTests {
    ...
    /// telemetry. Otherwise "Approve for me" gets bypassed by coterm's Feed UI.
