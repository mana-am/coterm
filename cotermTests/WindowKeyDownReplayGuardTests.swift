...
/// Regression coverage for https://github.com/emergent-inc/coterm/issues/5887.
///
/// `NSWindow.coterm_performKeyEquivalent(with:)` force-dispatches certain key
...
final class WindowKeyDownReplayGuardTests: XCTestCase {
    ...
    /// bypass in `coterm_performKeyEquivalent` force-dispatches this into the
    /// first responder's `keyDown`, which is the unguarded dispatch the
    /// https://github.com/emergent-inc/coterm/issues/5887 crash looped through.
