...
struct BrowserSSLTrustBypassStateTests {
    ...
    func errorPageRetryURLAllowsOnlyWebURLs() throws {
        ...
        #expect(BrowserErrorPage.retryURL(from: "coterm-browser-action://bypass-ssl?token=abc") == nil)
    ...
    func pendingBypassReplaysOriginalRequestOnceAndMarksHostBypassed() throws {
        ...
        #expect(actionURL.scheme == "coterm-browser-action")
    ...
    func pendingBypassRejectsMissingForgedAndExpiredTokens() throws {
        ...
        let missingTokenURL = try #require(URL(string: "coterm-browser-action://bypass-ssl"))
        let forgedTokenURL = try #require(URL(string: "coterm-browser-action://bypass-ssl?token=not-issued"))
