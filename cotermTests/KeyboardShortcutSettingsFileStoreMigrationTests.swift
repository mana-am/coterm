...
final class KeyboardShortcutSettingsFileStoreMigrationTests: XCTestCase {
    func testBootstrapMigratesLegacySettingsIntoCanonicalConfig() throws {
        ...
        XCTAssertTrue(primaryContents.contains(#""$schema": "https://raw.githubusercontent.com/emergent-inc/coterm/main/web/data/coterm.schema.json""#))
    ...
    func testCanonicalConfigOverridesLegacySettingsPerKey() throws {
        ...
        let primaryURL = directoryURL.appendingPathComponent("coterm.json", isDirectory: false)
    ...
    func testLegacySettingsShortcutBindingsParseWithoutRuntimeConflictLookup() throws {
        ...
        let liveSettingsFileURL = directoryURL.appendingPathComponent("live-coterm.json", isDirectory: false)
        try writeSettingsFile(
            """
            {
              "shortcuts": {
    ...
    private func makeTemporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory.appendingPathComponent(
            "coterm-settings-migration-\(UUID().uuidString)",
            isDirectory: true
        )
