...
final class FilePreviewReviewFeedbackTests: XCTestCase {
    func testAppBundleExportsFilePreviewDragType() {
        ...
        XCTAssertTrue(
            exported.contains("com.coterm.filepreview.transfer"),
    ...
    // Regression test for emergent-inc/coterm#4576: drag-selecting deep into a large file pegged the
