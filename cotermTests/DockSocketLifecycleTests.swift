...
struct DockSocketLifecycleTests {
    ...
    func dockPaneRoutingAndFocusedCloseStayInDock() throws {
        ...
        try withDockEnabled {
            ...
            activeWindow.identifier = NSUserInterfaceItemIdentifier("coterm.main.\(activeWindowId.uuidString)")
            ...
            dockWindow.identifier = NSUserInterfaceItemIdentifier("coterm.main.\(dockWindowId.uuidString)")
