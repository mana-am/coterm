...
struct cotermApp: App {
    @UIApplicationDelegateAdaptor(CotermAppDelegate.self) private var appDelegate
    ...
    private static let root: AppCompositionRoot = {
        ...
        let runtime = CotermMobileRuntime(
            ...
            stackAccessTokenProvider: CotermMobileRuntime.stackAccessTokenProvider(from: auth.coordinator),
            stackAccessTokenForStatusProvider: CotermMobileRuntime.stackAccessTokenForStatusProvider(from: auth.coordinator),
            stackAccessTokenForceRefresher: CotermMobileRuntime.stackAccessTokenForceRefresher(from: auth.coordinator)
        )
