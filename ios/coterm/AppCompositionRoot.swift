...
/// Holds the de-singletonized graph the `cotermApp` builds once at launch.
///
...
final class AppCompositionRoot {
    ...
    init(
        ...
        // (`COTERM_UITEST_MOCK_DATA`/XCUITest) or a dogfood auto-pair attach URL is
    ...
    /// the injected ``CotermMobileAnalytics/AnalyticsSessionizer`` and persisted
    /// ``CotermMobileAnalytics/AnalyticsSessionStore``, emitting `ios_session_started`
