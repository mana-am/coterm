...
/// Adapts the auth runtime's ``CotermAuthRuntime/TokenProviding`` to the analytics
/// package's ``CotermMobileAnalytics/AnalyticsTokenProviding``.
///
/// The analytics package must not depend on `CotermAuthRuntime`, so this bridge
