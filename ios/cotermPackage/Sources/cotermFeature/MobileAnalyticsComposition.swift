...
///
/// Builds the de-singletonized ``CotermMobileAnalytics/AnalyticsEmitter`` once at
...
public struct MobileAnalyticsComposition {
    ...
    ///
    /// - Parameters:
    ///   - apiBaseURL: The coterm web API base URL (no trailing slash), from
    ...
    /// ``CotermMobileAnalytics/AnalyticsEmitter``.
