...
public struct CotermMobileRuntime: Sendable, MobileSyncRuntime {
    ...
    public init(
        ...
        pairingAttemptTimeoutNanoseconds: UInt64 = CotermMobileRuntime.defaultPairingAttemptTimeoutNanoseconds,
...
struct MobileShellDevStackAuthTokenProvider {
    ...
    static let environmentKey = "COTERM_MOBILE_DEV_STACK_AUTH_TOKEN"
