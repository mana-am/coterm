...
actor CotermRuntimeDebugCaptureSender {
    private let maxInFlightRequests: Int
    private let sequence = CotermRuntimeDebugCaptureSequence()
    ...
    func sendIfCapacityAvailable(
        configuration: CotermRuntimeDebugCaptureConfiguration,
        hypothesisID: String,
        source: String,
        name: String,
        expected: String?,
