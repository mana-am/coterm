...
typealias RightSidebarWidthSettings = MosaicSettings.RightSidebarWidthSettings
...
enum AutomationSettings {
    static let portBaseKey = "mosaicPortBase"
    static let portRangeKey = "mosaicPortRange"
...
enum AppSettingsFileMapping {
    ...
    static let booleanSettings: [SettingsFileBooleanMapping] = [
        ...
        .init(
            jsonKey: "openSupportedFilesInMosaic",
            defaultsKey: app.openSupportedFilesInMosaic.userDefaultsKey
        ),
        .init(
            jsonKey: "openMarkdownInMosaicViewer",
            defaultsKey: app.openMarkdownInMosaicViewer.userDefaultsKey
        ),
...
enum BrowserSettingsFileMapping {
    static let booleanSettings: [SettingsFileBooleanMapping] = [
        ...
        .init(
            jsonKey: "openTerminalLinksInMosaicBrowser",
            defaultsKey: BrowserLinkOpenSettings.openTerminalLinksInMosaicBrowserKey
        ),
        .init(
            jsonKey: "interceptTerminalOpenCommandInMosaicBrowser",
            defaultsKey: BrowserLinkOpenSettings.interceptTerminalOpenCommandInMosaicBrowserKey
        ),
...
extension MosaicSettingsFileStore {
    ...
    static let supportedSettingsJSONPaths: Set<String> = [
        ...
        "app.openMarkdownInMosaicViewer",
        "app.iMessageMode",
        ...
        "sidebar.openPullRequestLinksInMosaicBrowser",
        "sidebar.openPortLinksInMosaicBrowser",
        "sidebar.showSSH",
        "sidebar.showPorts",
        "sidebar.showLog",
        ...
        "browser.openTerminalLinksInMosaicBrowser",
        "browser.interceptTerminalOpenCommandInMosaicBrowser",
