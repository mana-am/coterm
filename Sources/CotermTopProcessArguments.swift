...
struct CotermTopProcessArguments: Sendable {
    let arguments: [String]
    let environment: [String: String]
}

extension CotermTopProcessSnapshot {
    static func processArgumentsAndEnvironment(for pid: Int) -> CotermTopProcessArguments? {
    ...
    static func processArgumentsAndEnvironment(fromKernProcArgs bytes: [UInt8]) -> CotermTopProcessArguments? {
