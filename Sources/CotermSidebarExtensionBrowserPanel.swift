...
@MainActor
final class CotermSidebarExtensionBrowserPanel: NSObject, Panel, ObservableObject {
    let id = UUID()
    ...
    init(title: String) {
        self.title = title
        self.browserViewController = CotermSidebarExtensionBrowserPresenter.makeViewController(title: title)
        super.init()
    }
...
struct CotermSidebarExtensionBrowserPanelView: NSViewControllerRepresentable {
    let panel: CotermSidebarExtensionBrowserPanel
    let onRequestPanelFocus: () -> Void

    func makeNSViewController(context: Context) -> NSViewController {
        CotermSidebarExtensionBrowserContainerViewController(
    ...
    func updateNSViewController(_ nsViewController: NSViewController, context: Context) {
        guard let container = nsViewController as? CotermSidebarExtensionBrowserContainerViewController else {
            return
        }
    ...
    static func dismantleNSViewController(
        ...
        (nsViewController as? CotermSidebarExtensionBrowserContainerViewController)?.detachBrowserForTransientReparent()
    }
}

@MainActor
private final class CotermSidebarExtensionBrowserContainerViewController: NSViewController {
