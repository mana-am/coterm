...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:language": localized("settings.search.alias.setting.app.language", defaultValue: "app.language locale l10n localization translation english en restart"),
        ...
        "app:supported-file-previews": localized("settings.search.alias.setting.app.supported-file-previews", defaultValue: "app.openSupportedFilesInCoterm cmd click file preview pdf image video audio quicklook quick look editor external"),
        ...
        "app:markdown-viewer": localized("settings.search.alias.setting.app.markdown-viewer", defaultValue: "app.openMarkdownInCotermViewer md markdown mdx viewer preview readme"),
        ...
        "sidebarAppearance:open-pr-links": localized("settings.search.alias.setting.app.open-pr-links", defaultValue: "sidebar.openPullRequestLinksInCotermBrowser pr links github browser default external embedded"),
        "sidebarAppearance:open-port-links": localized("settings.search.alias.setting.app.open-port-links", defaultValue: "sidebar.openPortLinksInCotermBrowser ports localhost links browser default external embedded"),
        ...
        "automation:port-base": localized("settings.search.alias.setting.automation.port-base", defaultValue: "automation.portBase coterm_port start first base env environment variable"),
        "automation:port-range": localized("settings.search.alias.setting.automation.port-range", defaultValue: "automation.portRange coterm_port_end range size count env ports"),
        ...
        "browser:terminal-links": localized("settings.search.alias.setting.browser.terminal-links", defaultValue: "browser.openTerminalLinksInCotermBrowser click url terminal links open in browser href"),
        "browser:intercept-open": localized("settings.search.alias.setting.browser.intercept-open", defaultValue: "browser.interceptTerminalOpenCommandInCotermBrowser open command http https url terminal intercept"),
        ...
        "keyboardShortcuts:shortcut-chords": localized("settings.search.alias.setting.keyboardShortcuts.shortcut-chords", defaultValue: "tmux prefix ctrl-b control-b multi key sequence chord coterm json"),
        ...
        "keyboardShortcuts:shortcuts": localized("settings.search.alias.setting.keyboardShortcuts.shortcuts", defaultValue: "hotkeys keybindings key bindings commands keyboard accelerators shortcuts coterm json"),
        ...
        "settingsJSON:open-file": localized("settings.search.alias.setting.settingsJSON.open-file", defaultValue: "open config file json jsonc config editor ~/.config coterm preferences"),
        "settingsJSON:documentation": localized("settings.search.alias.setting.settingsJSON.documentation", defaultValue: "docs documentation schema reference coterm json keys configuration"),
