...
extension NSApplication {
    var isAppleScriptEnabled: Bool {
        // coterm always enables AppleScript — the underlying Ghostty fork
...
@MainActor
@objc(CotermScriptInputTextCommand)
