...
actor SearchIndex {
    ...
    nonisolated static func open(databaseURL: URL = .cotermSearchDatabaseURL) async throws -> SearchIndex {
    ...
    init(databaseURL: URL = .cotermSearchDatabaseURL) throws {
...
extension URL {
    static var cotermSearchDatabaseURL: URL {
