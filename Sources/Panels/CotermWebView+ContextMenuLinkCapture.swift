...
/// Context-menu link resolution for `CotermWebView`.
///
...
extension CotermWebView {
    ...
    /// stored property lives in `CotermWebView.swift` because extensions cannot
    ...
    private static let contextMenuLinkCaptureMessageHandlerName = "cotermContextMenuLinkCapture"
...
private final class ContextMenuLinkCaptureMessageHandler: NSObject, WKScriptMessageHandler {
    func userContentController(
        ...
        guard let webView = message.webView as? CotermWebView else { return }
