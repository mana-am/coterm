...
final class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate, NSMenuItemValidation, NSMenuDelegate, CotermConfigStoreReloadEnvironment {
    ...
    private let sessionPersistenceQueue = DispatchQueue(
        label: "cc.coterm.app.sessionPersistence",
        qos: .utility
    )
    ...
    private nonisolated static let launchServicesRegistrationQueue = DispatchQueue(
        label: "cc.coterm.app.launchServicesRegistration",
        qos: .utility
    )
    ...
    @objc func installCotermCLIInPath(_ sender: Any?) {
        ...
        do {
            ...
            presentCLIPathAlert(
                title: String(localized: "cli.installed", defaultValue: "CLI Installed"),
                informativeText: informativeText,
                style: .informational
            )
        } catch {
            presentCLIPathAlert(
                title: String(localized: "cli.installFailed", defaultValue: "Couldn't Install CLI"),
    ...
    @objc func uninstallCotermCLIInPath(_ sender: Any?) {
        ...
        do {
            ...
            presentCLIPathAlert(
                title: String(localized: "cli.uninstalled", defaultValue: "CLI Uninstalled"),
                informativeText: informativeText,
                style: .informational
            )
        } catch {
            presentCLIPathAlert(
                title: String(localized: "cli.uninstallFailed", defaultValue: "Couldn't Uninstall CLI"),
                informativeText: error.localizedDescription,
                style: .warning
            )
        }
