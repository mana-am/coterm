...
typealias RightSidebarWidthSettings = CotermSettings.RightSidebarWidthSettings
...
enum AutomationSettings {
    static let portBaseKey = "cotermPortBase"
    static let portRangeKey = "cotermPortRange"
...
enum AppSettingsFileMapping {
    ...
    static let booleanSettings: [SettingsFileBooleanMapping] = [
        ...
        .init(
            jsonKey: "openSupportedFilesInCoterm",
            defaultsKey: app.openSupportedFilesInCoterm.userDefaultsKey
        ),
        .init(
            jsonKey: "openMarkdownInCotermViewer",
            defaultsKey: app.openMarkdownInCotermViewer.userDefaultsKey
        ),
...
enum BrowserSettingsFileMapping {
    static let booleanSettings: [SettingsFileBooleanMapping] = [
        ...
        .init(
            jsonKey: "openTerminalLinksInCotermBrowser",
            defaultsKey: BrowserLinkOpenSettings.openTerminalLinksInCotermBrowserKey
        ),
        .init(
            jsonKey: "interceptTerminalOpenCommandInCotermBrowser",
            defaultsKey: BrowserLinkOpenSettings.interceptTerminalOpenCommandInCotermBrowserKey
        ),
...
extension CotermSettingsFileStore {
    ...
    // validate against this set so new persisted settings need an explicit coterm.json review.
    static let supportedSettingsJSONPaths: Set<String> = [
        ...
        "app.openMarkdownInCotermViewer",
        "app.iMessageMode",
        ...
        "sidebar.openPullRequestLinksInCotermBrowser",
        "sidebar.openPortLinksInCotermBrowser",
        "sidebar.showSSH",
        "sidebar.showPorts",
        "sidebar.showLog",
        ...
        "browser.openTerminalLinksInCotermBrowser",
        "browser.interceptTerminalOpenCommandInCotermBrowser",
