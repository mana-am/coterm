...
enum TerminalScrollBarSettings {
    ...
    static let didChangeNotification = Notification.Name("coterm.terminalScrollBarSettingsDidChange")
...
enum TerminalCopyOnSelectSettings {
    ...
    static let didChangeNotification = Notification.Name("coterm.terminalCopyOnSelectSettingsDidChange")
...
enum AgentSessionAutoResumeSettings {
    ...
    static let didChangeNotification = Notification.Name("coterm.agentSessionAutoResumeSettingsDidChange")
...
enum AgentHibernationSettings {
    ...
    static let didChangeNotification = Notification.Name("coterm.agentHibernationSettingsDidChange")
...
enum RendererRealizationSettings {
    ...
    static let didChangeNotification = Notification.Name("coterm.rendererRealizationSettingsDidChange")
...
enum UITestLaunchManifest {
    static let argumentName = "-cotermUITestLaunchManifest"
