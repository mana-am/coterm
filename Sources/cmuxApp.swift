...
struct cmuxApp: App {
    ...
    init() {
        ...
        // directory (https://github.com/emergent-inc/cmux/issues/5146). The app
        ...
        // https://github.com/emergent-inc/cmux/issues/4678.
        ...
        // launches. See https://github.com/emergent-inc/cmux/issues/753.
    ...
    private static func terminateForMissingLaunchTag() -> Never {
        let message = "error: refusing to launch untagged Mosaic DEV; start with ./scripts/reload.sh --tag <name> (or set CMUX_TAG for test harnesses)"
        fputs("\(message)\n", stderr)
        fflush(stderr)
        NSLog("%@", message)
        Darwin.exit(64)
    ...
    var body: some Scene {
        ...
        .commands {
            ...
            CommandGroup(replacing: .appTermination) {
                splitCommandButton(title: String(localized: "menu.quitCmux", defaultValue: "Quit mosaic"), shortcut: menuShortcut(for: .quit)) {
                    NSApp.terminate(nil)
                }
            }
