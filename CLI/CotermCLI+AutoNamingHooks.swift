...
extension CotermCLI {
    ...
    func spawnDetachedAgentAutoName(
        ...
        let selfPath: String = {
            ...
            if let bundled = normalizedHookValue(env["COTERM_BUNDLED_CLI_PATH"]),
        ...
        var spawnEnv = env
        spawnEnv["COTERM_CLAUDE_HOOK_STATE_PATH"] = agentHookStatePath(sessionStoreSuffix: def.sessionStoreSuffix, env: env)
