...
struct CotermAgentTurnDiffBaselineRecord: Codable {
...
struct CotermAgentTurnDiffBaselineStore: Codable {
    var version: Int = 1
    var records: [CotermAgentTurnDiffBaselineRecord] = []
}

private enum CotermAgentTurnUntrackedSnapshotLimits {
    static let maxFiles = 64
    static let maxFileBytes: UInt64 = 1 * 1024 * 1024
    static let maxTotalBytes: UInt64 = 4 * 1024 * 1024
}

enum CotermAgentTurnDiffBaselineFile {
    static func path(env: [String: String] = ProcessInfo.processInfo.environment) -> String {
        if let overrideDirectory = normalized(env["COTERM_AGENT_HOOK_STATE_DIR"]) {
        ...
        return homeExpandedPath("~/.coterm/agent-turn-diff-baselines.json", env: env)
    }
...
enum CotermDiffViewerLocalization {
    static func string(
        _ key: String,
        defaultValue: String,
...
extension CotermCLI {
    ...
    private struct DiffViewerURLMapper {
        ...
        static let sessionHistoryMarker = "coterm-diff-viewer"
        ...
        func viewerURL(for fileURL: URL) throws -> URL {
            ...
            if origin.scheme == Self.scheme {
                ...
                // (`coterm-diff-viewer://<token>`), and the in-app scheme handler
    ...
    /// `/__coterm_diff_viewer_branch` regenerate endpoint runs in the separate
    /// server process, which has none of the original `coterm diff` invocation's
    ...
    private struct DiffViewerLabels {
        ...
        static func localized() -> DiffViewerLabels {
            DiffViewerLabels(values: [
                "additions": CotermDiffViewerLocalization.string("diffViewer.additions", defaultValue: "Additions"),
                "addComment": CotermDiffViewerLocalization.string("diffViewer.addComment", defaultValue: "Add comment"),
                "bars": CotermDiffViewerLocalization.string("diffViewer.bars", defaultValue: "Bars"),
                "cancelComment": CotermDiffViewerLocalization.string("diffViewer.cancelComment", defaultValue: "Cancel"),
                "comments": CotermDiffViewerLocalization.string("diffViewer.comments", defaultValue: "Comments"),
                "commentPlaceholder": CotermDiffViewerLocalization.string("diffViewer.commentPlaceholder", defaultValue: "Leave a comment"),
                "deleteComment": CotermDiffViewerLocalization.string("diffViewer.deleteComment", defaultValue: "Delete"),
                "editComment": CotermDiffViewerLocalization.string("diffViewer.editComment", defaultValue: "Edit"),
                "noComments": CotermDiffViewerLocalization.string("diffViewer.noComments", defaultValue: "No comments yet"),
                "outdatedComment": CotermDiffViewerLocalization.string("diffViewer.outdatedComment", defaultValue: "Outdated"),
                "saveComment": CotermDiffViewerLocalization.string("diffViewer.saveComment", defaultValue: "Comment"),
                "changedFiles": CotermDiffViewerLocalization.string("diffViewer.changedFiles", defaultValue: "Changed files"),
                "classic": CotermDiffViewerLocalization.string("diffViewer.classic", defaultValue: "Classic"),
                "commit": CotermDiffViewerLocalization.string("about.commit", defaultValue: "Commit"),
                "collapseAllDiffs": CotermDiffViewerLocalization.string("diffViewer.collapseAllDiffs", defaultValue: "Collapse all diffs"),
                "collapseUnchangedContext": CotermDiffViewerLocalization.string("diffViewer.collapseUnchangedContext", defaultValue: "Collapse unchanged context"),
                "copyFailedGitApplyCommand": CotermDiffViewerLocalization.string("diffViewer.copyFailedGitApplyCommand", defaultValue: "Could not copy git apply command."),
                "copiedGitApplyCommand": CotermDiffViewerLocalization.string("diffViewer.copiedGitApplyCommand", defaultValue: "Copied git apply command"),
                "copyGitApplyCommand": CotermDiffViewerLocalization.string("diffViewer.copyGitApplyCommand", defaultValue: "Copy git apply command"),
                "deletions": CotermDiffViewerLocalization.string("diffViewer.deletions", defaultValue: "Deletions"),
                "diffStats": CotermDiffViewerLocalization.string("diffViewer.diffStats", defaultValue: "Diff stats"),
                "diffTarget": CotermDiffViewerLocalization.string("diffViewer.diffTarget", defaultValue: "Diff target"),
                "diffViewer": CotermDiffViewerLocalization.string("diffViewer.diffViewer", defaultValue: "Diff viewer"),
                "renderFailed": CotermDiffViewerLocalization.string("diffViewer.renderFailed", defaultValue: "Could not render this diff. Check the patch input and try again."),
                "disableWordDiffs": CotermDiffViewerLocalization.string("diffViewer.disableWordDiffs", defaultValue: "Disable word diffs"),
                "disableWordWrap": CotermDiffViewerLocalization.string("diffViewer.disableWordWrap", defaultValue: "Disable word wrap"),
                "enableWordDiffs": CotermDiffViewerLocalization.string("diffViewer.enableWordDiffs", defaultValue: "Enable word diffs"),
                "enableWordWrap": CotermDiffViewerLocalization.string("diffViewer.enableWordWrap", defaultValue: "Enable word wrap"),
                "expandAllDiffs": CotermDiffViewerLocalization.string("diffViewer.expandAllDiffs", defaultValue: "Expand all diffs"),
                "expandUnchangedContext": CotermDiffViewerLocalization.string("diffViewer.expandUnchangedContext", defaultValue: "Expand unchanged context"),
                "files": CotermDiffViewerLocalization.string("diffViewer.files", defaultValue: "Files"),
                "hideBackgrounds": CotermDiffViewerLocalization.string("diffViewer.hideBackgrounds", defaultValue: "Hide backgrounds"),
                "hideFiles": CotermDiffViewerLocalization.string("diffViewer.hideFiles", defaultValue: "Hide files"),
                "hideFileSearch": CotermDiffViewerLocalization.string("diffViewer.hideFileSearch", defaultValue: "Hide file search"),
                "hideLineNumbers": CotermDiffViewerLocalization.string("diffViewer.hideLineNumbers", defaultValue: "Hide line numbers"),
                "indicatorStyle": CotermDiffViewerLocalization.string("diffViewer.indicatorStyle", defaultValue: "Indicator style"),
                "jumpToFile": CotermDiffViewerLocalization.string("diffViewer.jumpToFile", defaultValue: "Jump to file"),
                "loadingDiff": CotermDiffViewerLocalization.string("diffViewer.loadingDiff", defaultValue: "Loading diff..."),
                "loadingRenderer": CotermDiffViewerLocalization.string("diffViewer.loadingRenderer", defaultValue: "Loading renderer..."),
                "noFileDiffs": CotermDiffViewerLocalization.string("diffViewer.noFileDiffs", defaultValue: "No file diffs found in patch input."),
                "none": CotermDiffViewerLocalization.string("diffViewer.none", defaultValue: "None"),
                "openSourceURL": CotermDiffViewerLocalization.string("diffViewer.openSourceURL", defaultValue: "Open source URL"),
                "options": CotermDiffViewerLocalization.string("diffViewer.options", defaultValue: "Options"),
                "parsingDiff": CotermDiffViewerLocalization.string("diffViewer.parsingDiff", defaultValue: "Parsing diff..."),
                "refresh": CotermDiffViewerLocalization.string("diffViewer.refresh", defaultValue: "Refresh"),
                "renderingDiff": CotermDiffViewerLocalization.string("diffViewer.renderingDiff", defaultValue: "Rendering diff..."),
                "repoPath": CotermDiffViewerLocalization.string("diffViewer.repoPath", defaultValue: "Repository path"),
                "branchBase": CotermDiffViewerLocalization.string("diffViewer.branchBase", defaultValue: "Branch base"),
                "branchPickerCurrent": CotermDiffViewerLocalization.string("diffViewer.branchPickerCurrent", defaultValue: "current"),
                "branchPickerBasePrefix": CotermDiffViewerLocalization.string("diffViewer.branchPickerBasePrefix", defaultValue: "Base:"),
                "branchPickerComparing": CotermDiffViewerLocalization.string("diffViewer.branchPickerComparing", defaultValue: "Comparing {head} against {base}"),
                "branchPickerFilterPlaceholder": CotermDiffViewerLocalization.string("diffViewer.branchPickerFilterPlaceholder", defaultValue: "Filter branches"),
                "branchPickerGenerating": CotermDiffViewerLocalization.string("diffViewer.branchPickerGenerating", defaultValue: "Generating diff against {ref}..."),
                "branchPickerGroupBranches": CotermDiffViewerLocalization.string("diffViewer.branchPickerGroupBranches", defaultValue: "Branches"),
                "branchPickerGroupRecent": CotermDiffViewerLocalization.string("diffViewer.branchPickerGroupRecent", defaultValue: "Recent"),
                "branchPickerGroupRemotes": CotermDiffViewerLocalization.string("diffViewer.branchPickerGroupRemotes", defaultValue: "Remotes"),
                "branchPickerGroupSuggested": CotermDiffViewerLocalization.string("diffViewer.branchPickerGroupSuggested", defaultValue: "Suggested"),
                "branchPickerGroupWorktrees": CotermDiffViewerLocalization.string("diffViewer.branchPickerGroupWorktrees", defaultValue: "Worktrees"),
                "branchPickerLoadFailed": CotermDiffViewerLocalization.string("diffViewer.branchPickerLoadFailed", defaultValue: "Could not load branches."),
                "branchPickerMore": CotermDiffViewerLocalization.string("diffViewer.branchPickerMore", defaultValue: "{count} more, type to filter"),
                "branchPickerLoading": CotermDiffViewerLocalization.string("diffViewer.branchPickerLoading", defaultValue: "Loading branches..."),
                "branchPickerNoMatches": CotermDiffViewerLocalization.string("diffViewer.branchPickerNoMatches", defaultValue: "No matching branches"),
                "branchPickerOpen": CotermDiffViewerLocalization.string("diffViewer.branchPickerOpen", defaultValue: "Change diff base"),
                "branchPickerUseRaw": CotermDiffViewerLocalization.string("diffViewer.branchPickerUseRaw", defaultValue: "Use \"{ref}\" (raw)"),
                "showBackgrounds": CotermDiffViewerLocalization.string("diffViewer.showBackgrounds", defaultValue: "Show backgrounds"),
                "showFiles": CotermDiffViewerLocalization.string("diffViewer.showFiles", defaultValue: "Show files"),
                "showFileSearch": CotermDiffViewerLocalization.string("diffViewer.showFileSearch", defaultValue: "Show file search"),
                "showLineNumbers": CotermDiffViewerLocalization.string("diffViewer.showLineNumbers", defaultValue: "Show line numbers"),
                "switchToSplitDiff": CotermDiffViewerLocalization.string("diffViewer.switchToSplitDiff", defaultValue: "Switch to split diff"),
                "switchToUnifiedDiff": CotermDiffViewerLocalization.string("diffViewer.switchToUnifiedDiff", defaultValue: "Switch to unified diff"),
                "untitled": CotermDiffViewerLocalization.string("diffViewer.untitled", defaultValue: "Untitled"),
            ])
        }
    }
    ...
    private enum DiffSource: CaseIterable, Equatable {
        ...
        var menuLabel: String {
            switch self {
            case .unstaged: return CotermDiffViewerLocalization.string("diffViewer.source.unstaged", defaultValue: "Unstaged")
            case .staged: return CotermDiffViewerLocalization.string("diffViewer.source.staged", defaultValue: "Staged")
            case .branch: return CotermDiffViewerLocalization.string("diffViewer.source.branch", defaultValue: "Branch")
            case .lastTurn: return CotermDiffViewerLocalization.string("diffViewer.source.lastTurn", defaultValue: "Last turn")
            }
        }

        var title: String {
            switch self {
            case .unstaged: return CotermDiffViewerLocalization.string("diffViewer.title.unstagedChanges", defaultValue: "Unstaged changes")
            case .staged: return CotermDiffViewerLocalization.string("diffViewer.title.stagedChanges", defaultValue: "Staged changes")
            case .branch: return CotermDiffViewerLocalization.string("diffViewer.title.branchDiff", defaultValue: "Branch diff")
            case .lastTurn: return CotermDiffViewerLocalization.string("diffViewer.title.lastTurnDiff", defaultValue: "Last turn diff")
            }
        }

        var emptyMessage: String {
            switch self {
            case .unstaged: return CotermDiffViewerLocalization.string("diffViewer.empty.unstaged", defaultValue: "No unstaged changes to diff.")
            case .staged: return CotermDiffViewerLocalization.string("diffViewer.empty.staged", defaultValue: "No staged changes to diff.")
            case .branch: return CotermDiffViewerLocalization.string("diffViewer.empty.branch", defaultValue: "No branch changes to diff.")
            case .lastTurn: return CotermDiffViewerLocalization.string("diffViewer.empty.lastTurn", defaultValue: "No last-turn changes to diff.")
            }
        }
    }
    ...
    func runOpenCommand(
        ...
        guard !parsedArgs.targets.isEmpty else {
            throw CLIError(message: "open requires at least one path or URL. Usage: coterm open <path-or-url>...")
        }
        ...
        let workspaceRaw = parsedArgs.workspace ?? (parsedArgs.window == nil ? ProcessInfo.processInfo.environment["COTERM_WORKSPACE_ID"] : nil)
        ...
        let surfaceRaw = parsedArgs.surface ?? (shouldInheritCallerSurface ? ProcessInfo.processInfo.environment["COTERM_SURFACE_ID"] : nil)
    ...
    func runDiffCommand(
        ...
        guard parsedArgs.inputs.count <= 1 else {
            throw CLIError(message: "diff accepts at most one patch file. Usage: coterm diff [patch-file|-] [options]")
        }
        ...
        func resolveTargetIfNeeded() throws {
            ...
            let surfaceRaw = parsedArgs.surface ?? (parsedArgs.window == nil ? ProcessInfo.processInfo.environment["COTERM_SURFACE_ID"] : nil)
    ...
    private func taggedDiffViewerExecutableURL(socketPath: String) -> URL? {
        ...
        let candidate = URL(fileURLWithPath: homePath, isDirectory: true)
            .appendingPathComponent("Library/Developer/Xcode/DerivedData/coterm-\(tag)", isDirectory: true)
            .appendingPathComponent("Build/Products/Debug/Coterm DEV \(tag).app", isDirectory: true)
    ...
    private func parseOpenArguments(_ commandArgs: [String]) throws -> OpenArguments {
        ...
        while index < commandArgs.count {
            ...
            if isParsingOptions {
                ...
                default:
                    if arg.hasPrefix("-") {
                        throw CLIError(message: "open: unknown flag '\(arg)'. Usage: coterm open <path-or-url>... [--workspace <id|ref|index>] [--surface <id|ref|index>] [--pane <id|ref|index>] [--window <id|ref|index>] [--focus true|false] [--no-focus]")
                    }
                }
            }
            ...
            if isParsingOptions {
                ...
                default:
                    if arg.hasPrefix("-"), arg != "-" {
                        throw CLIError(message: "diff: unknown flag '\(arg)'. Usage: coterm diff [patch-file|-] [--source <unstaged|staged|branch|last-turn>] [--workspace <id|ref|index>] [--surface <id|ref|index>] [--window <id|ref|index>] [--session <id>] [--cwd <path>] [--base <ref>] [--focus true|false] [--no-focus] [--title <text>] [--layout split|unified] [--font-size <points>]")
                    }
                }
            }
    ...
    private func readDiffInput(
        ...
        guard let rawInput, rawInput != "-" else {
            guard isatty(STDIN_FILENO) == 0 else {
                throw CLIError(message: "diff requires a patch file, piped stdin, or a git source. Usage: coterm diff <patch-file>|-|--unstaged|--staged|--branch|--last-turn")
            }
            let data = FileHandle.standardInput.readDataToEndOfFile()
            return DiffInput(
                patch: try decodeDiffData(data, sourceDescription: "stdin"),
                sourceLabel: "stdin",
                defaultTitle: "coterm diff",
                emptyMessage: nil,
                externalURL: nil
            )
        }
        ...
        return DiffInput(
            ...
            defaultTitle: filename.isEmpty ? "coterm diff" : filename,
            emptyMessage: nil,
            externalURL: nil
        )
    }
    ...
    private func diffViewerShouldStreamRemotePatch() -> Bool {
        let value = ProcessInfo.processInfo.environment["COTERM_DIFF_VIEWER_STREAM_REMOTE"]?
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .lowercased()
    ...
    private func readGitDiffInput(source: DiffSource, context: DiffSourceContext) throws -> DiffInput {
        ...
        case .lastTurn:
            guard let workspaceId = normalizedDiffSourceValue(context.workspaceId),
                ...
                throw CLIError(message: "coterm diff --last-turn requires a workspace and surface context. Run it from a coterm terminal or pass --workspace and --surface.")
            }
            let sessionId = normalizedDiffSourceValue(context.sessionId)
            let env = ProcessInfo.processInfo.environment
            let baselineStorePath = CotermAgentTurnDiffBaselineFile.path(env: env)
    ...
    private func gitRepoRoot(startingAt directory: String) throws -> String {
        do {
            ...
            throw CLIError(message: "coterm diff git sources require a git repository")
        }
    }
    ...
    private func diffBranchBaseReasonLabel(_ reason: String) -> String {
        ...
        case DiffBranchBaseReason.createdFrom:
            return CotermDiffViewerLocalization.string("diffViewer.baseReason.createdFrom", defaultValue: "created from")
        case DiffBranchBaseReason.prBase:
            return CotermDiffViewerLocalization.string("diffViewer.baseReason.prBase", defaultValue: "PR base")
        case DiffBranchBaseReason.forkPoint:
            return CotermDiffViewerLocalization.string("diffViewer.baseReason.forkPoint", defaultValue: "fork point")
        case DiffBranchBaseReason.default:
            return CotermDiffViewerLocalization.string("diffViewer.baseReason.default", defaultValue: "default")
        case DiffBranchBaseReason.manual:
            return CotermDiffViewerLocalization.string("diffViewer.baseReason.manual", defaultValue: "manual")
        default:
            return reason
        }
    }
    ...
    /// choice. Otherwise walk the heuristic order: recorded cotermBase -> PR base ->
    ...
    private func resolvedDiffBranchBase(_ rawBaseRef: String?, in repoRoot: String) throws -> DiffBranchBase {
        ...
        // 1. Recorded creation base written by new-coterm-worktree.sh. Read-only.
        if let branchName,
           let recorded = try? gitSingleLine(["config", "--get", "branch.\(branchName).cotermBase"], in: repoRoot),
           !recorded.isEmpty,
    ...
    private func diffBranchRefGroups(in repoRoot: String, selectedBaseRef: String?) -> [DiffBranchRefGroup] {
        ...
        // Surface each individual heuristic source so cotermBase and PR base can
        ...
        if !suggestedRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "suggested",
                    label: CotermDiffViewerLocalization.string("diffViewer.refGroup.suggested", defaultValue: "Suggested"),
                    rows: suggestedRows
                )
            )
        }
        ...
        if !worktreeRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "worktrees",
                    label: CotermDiffViewerLocalization.string("diffViewer.refGroup.worktrees", defaultValue: "Worktrees"),
                    rows: worktreeRows
                )
            )
        }
        ...
        if !branchRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "branches",
                    label: CotermDiffViewerLocalization.string("diffViewer.refGroup.branches", defaultValue: "Branches"),
                    rows: branchRows
                )
            )
        }
        ...
        if !remoteRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "remotes",
                    label: CotermDiffViewerLocalization.string("diffViewer.refGroup.remotes", defaultValue: "Remotes"),
                    rows: remoteRows
                )
            )
        }
        ...
        if !recentRows.isEmpty {
            groups.append(
                DiffBranchRefGroup(
                    id: "recent",
                    label: CotermDiffViewerLocalization.string("diffViewer.refGroup.recent", defaultValue: "Recent"),
                    rows: recentRows
                )
            )
        }
    ...
    /// pattern fixed in https://github.com/emergent-inc/coterm/pull/5347, and these
    ...
    private func gitUntrackedPatchSinceBaseline(
        record: CotermAgentTurnDiffBaselineRecord,
        in repoRoot: String,
        storePath: String
    ) throws -> String {
    ...
    private func safeTemporaryGitPathURL(relativePath: String) -> (root: URL, file: URL)? {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-diff-untracked-\(UUID().uuidString)", isDirectory: true)
    ...
    private func gitUntrackedPathHashes(
        ...
        for path in paths {
            guard hashes.count < CotermAgentTurnUntrackedSnapshotLimits.maxFiles,
            ...
            guard fileSize <= CotermAgentTurnUntrackedSnapshotLimits.maxFileBytes,
                  capturedBytes + fileSize <= CotermAgentTurnUntrackedSnapshotLimits.maxTotalBytes else {
                continue
            }
            do {
    ...
    func recordAgentTurnDiffBaseline(
        ...
        let storePath = CotermAgentTurnDiffBaselineFile.path(env: env)
        let untrackedSnapshot = try gitUntrackedPathHashes(
            paths: untrackedPaths,
            in: repoRoot,
            storePath: storePath
        )
        let record = CotermAgentTurnDiffBaselineRecord(
            workspaceId: workspaceId,
            surfaceId: surfaceId,
        ...
        do {
            var removedRecords: [CotermAgentTurnDiffBaselineRecord] = []
            ...
            try updateAgentTurnDiffBaselineStore(path: storePath, update: { store in
                func matchesCurrentScope(_ existing: CotermAgentTurnDiffBaselineRecord) -> Bool {
    ...
    private func agentTurnDiffBaselineCommit(in repoRoot: String) throws -> String {
        let stashResult = CLIProcessRunner.runProcess(
            executablePath: "/usr/bin/env",
            arguments: ["git", "-C", repoRoot, "stash", "create", "coterm last turn baseline"],
            timeout: 60
        )
    ...
    private func latestAgentTurnDiffBaseline(
        ...
        sessionId: String?,
        env: [String: String]
    ) throws -> CotermAgentTurnDiffBaselineRecord? {
        let store = try readAgentTurnDiffBaselineStore(path: CotermAgentTurnDiffBaselineFile.path(env: env))
    ...
    private func readAgentTurnDiffBaselineStore(path: String) throws -> CotermAgentTurnDiffBaselineStore {
        let url = URL(fileURLWithPath: path)
        guard FileManager.default.fileExists(atPath: url.path) else {
            return CotermAgentTurnDiffBaselineStore()
        }
        let data = try Data(contentsOf: url)
        return try JSONDecoder().decode(CotermAgentTurnDiffBaselineStore.self, from: data)
    }

    private func updateAgentTurnDiffBaselineStore(
        path: String,
        update: (inout CotermAgentTurnDiffBaselineStore) throws -> Void,
        afterWrite: ((CotermAgentTurnDiffBaselineStore) -> Void)? = nil
    ) throws {
        let url = URL(fileURLWithPath: path)
        ...
        var store = (try? readAgentTurnDiffBaselineStore(path: path)) ?? CotermAgentTurnDiffBaselineStore()
        try update(&store)
    ...
    private func pruneAgentTurnDiffBaselineStore(_ store: inout CotermAgentTurnDiffBaselineStore) {
    ...
    private func pruneAgentTurnDiffBaselineArtifacts(
        storePath: String,
        removedRecords: [CotermAgentTurnDiffBaselineRecord],
        retainedRecords: [CotermAgentTurnDiffBaselineRecord]
    ) {
    ...
    private func agentTurnDiffBaselineRecordEquals(
        _ lhs: CotermAgentTurnDiffBaselineRecord,
        _ rhs: CotermAgentTurnDiffBaselineRecord
    ) -> Bool {
    ...
    private func diffViewerAppearance(socketPath: String, fontSizeOverride: Double?) -> DiffViewerAppearance {
        ...
        appearance.lightTheme.generatedName = "coterm-ghostty-light-\(themeSuffix)"
        appearance.darkTheme.generatedName = "coterm-ghostty-dark-\(themeSuffix)"
    ...
    private func defaultDiffViewerAppearance() -> DiffViewerAppearance {
        var lightTheme = DiffViewerTheme(
            generatedName: "coterm-ghostty-light",
        ...
        var darkTheme = DiffViewerTheme(
            generatedName: "coterm-ghostty-dark",
    ...
    private func diffViewerLoadingDiffMessage(_ target: String) -> String {
        let format = CotermDiffViewerLocalization.string(
    ...
    private func writeCompleteGitDiffViewerHTMLSet(
        ...
        // verbatim. With no explicit base, the heuristic resolver (cotermBase -> PR
        ...
        for source in DiffSource.allCases {
            for option in repoCandidates where option.repoRoot != repoRoot {
                ...
                // renders against (and surfaces a picker for) the cotermBase/PR/
    ...
    /// custom scheme (`coterm-diff-viewer://<token>`) it yields a scheme URL whose
    ...
    private func diffViewerBranchRefsURL(origin: URL, repoRoot: String, token: String, base: String?) -> String {
        ...
        return diffViewerBranchEndpointURL(
            origin: origin,
            path: "/__coterm_diff_viewer_refs",
    ...
    private func diffViewerBranchRegenerateURLTemplate(
        ...
        let withSentinel = diffViewerBranchEndpointURL(
            origin: origin,
            path: "/__coterm_diff_viewer_branch",
            queryItems: [
                URLQueryItem(name: "group", value: groupID),
                URLQueryItem(name: "repo", value: repoRoot),
                URLQueryItem(name: "token", value: token),
                URLQueryItem(name: "base", value: "__COTERM_REF__")
            ]
        )
        ...
        // (arbitrary user path), leaving `base=__COTERM_REF__` unfilled and breaking
        // regeneration. `base` is the last query item, so `base=__COTERM_REF__`
        // appears verbatim and uniquely.
        return withSentinel.replacingOccurrences(of: "base=__COTERM_REF__", with: "base={ref}")
    }

    // MARK: - Headless picker commands (for the in-app custom-scheme handler)

    /// `coterm __diff-viewer-refs --repo <root> [--base <ref>]` -> grouped refs JSON
    ...
    /// custom-scheme handler to mirror the HTTP `/__coterm_diff_viewer_refs` route.
    ...
    /// `coterm __diff-viewer-branch --group <g> --repo <root> --base <ref>` ->
    ...
    /// mirror the HTTP `/__coterm_diff_viewer_branch` route after an app restart,
    ...
    private func agentTurnDiffBaselineRepoURLs(context: DiffSourceContext) -> [URL] {
        guard let workspaceId = normalizedDiffSourceValue(context.workspaceId),
              ...
              let store = try? readAgentTurnDiffBaselineStore(
                path: CotermAgentTurnDiffBaselineFile.path(env: ProcessInfo.processInfo.environment)
              ) else {
            return []
        }
        let sessionId = normalizedDiffSourceValue(context.sessionId)
    ...
    private func diffViewerDirectory() throws -> URL {
        let directory = URL(fileURLWithPath: "/tmp", isDirectory: true)
            .appendingPathComponent("coterm-diff-viewer-\(getuid())", isDirectory: true)
    ...
    private func startDiffViewerHTTPServer(rootDirectory: URL, runtime: URL? = nil) throws -> URL {
        guard let executableURL = diffViewerExecutableURL(for: runtime) else {
            throw CLIError(message: "Failed to resolve coterm executable for diff viewer server")
        }
    ...
    private func diffViewerHTTPServerIsReachable(port: Int) -> Bool {
        guard let url = URL(string: "http://127.0.0.1:\(port)/__coterm_diff_viewer_healthz") else {
            return false
        }
    ...
    private func handleDiffViewerHTTPConnection(
        ...
        do {
            ...
            if request.path == "/__coterm_diff_viewer_healthz" {
                try sendDiffViewerHTTPResponse(
                    fileDescriptor: fd,
                    status: 200,
                    reason: "OK",
            ...
            if request.path == "/__coterm_diff_viewer_refs" {
            ...
            if request.path == "/__coterm_diff_viewer_branch" {
            ...
            if request.path.hasPrefix("/__coterm_diff_viewer_wait/") {
    ...
    /// `GET /__coterm_diff_viewer_refs?repo=<root>&token=<t>` -> grouped refs JSON.
    ...
    /// `GET /__coterm_diff_viewer_branch?group=<g>&repo=<root>&base=<ref>` ->
    ...
    private func sendDiffViewerHTTPWaitForReplacement(
        ...
        let prefix = "/__coterm_diff_viewer_wait/"
    ...
    private func diffViewerHTTPReplacementWaitTimeout() -> TimeInterval {
        ...
        let key = "COTERM_DIFF_VIEWER_WAIT_TIMEOUT_SECONDS"
    ...
    private func sendDiffViewerHTTPWaitTimedOut(fileDescriptor fd: Int32, omitBody: Bool) throws {
        let title = CotermDiffViewerLocalization.string(
            "diffViewer.loadingDiff",
            defaultValue: "Loading diff..."
        )
        let message = CotermDiffViewerLocalization.string(
    ...
    private func diffViewerHTTPFileIsPending(_ fileURL: URL) -> Bool {
        ...
        return text.contains("data-coterm-diff-pending=\"true\"")
    }
    ...
    private func sendDiffViewerHTTPRemotePatch(
        ...
        headers["X-COTERM-Diff-Viewer-Remote"] = "github"
    ...
    private func diffViewerHTTPBaseHeaders(port: Int?) -> [String: String] {
        ...
        if let port {
            ...
            headers["X-COTERM-Diff-Viewer-Origin"] = "http://127.0.0.1:\(port)"
        }
        return headers
    }
    ...
    private func writeDiffViewerRedirectHTML(
        ...
        <body data-coterm-diff-redirect="\(escapedTarget)">
          <script>
    ...
    private func writeDiffViewerHTML(
        ...
        let pendingAttribute = pollForReplacement ? " data-coterm-diff-pending=\"true\"" : ""
        let prepaintStyle = diffViewerPrepaintStyle(appearance: appearance)
        let html = """
        <!doctype html>
        ...
        <body>
          <script id="coterm-diff-viewer-config" type="application/json">\(configLiteral)</script>
          <div id="root"></div>
    ...
    private func diffViewerPrepaintStyle(appearance: DiffViewerAppearance) -> String {
        ...
        return """
        <style id="coterm-diff-viewer-prepaint">
          :root {
    ...
    private func ensureDiffViewerAssets(nextTo viewerURL: URL, runtime: URL? = nil) throws -> DiffViewerAssets {
        ...
        guard appAssetPaths.contains("main.mjs") else {
            throw CLIError(message: "Bundled coterm diff viewer app entry asset not found")
        }
    ...
    private func diffViewerBundledAppAssetDirectory(
        ...
        let candidates: [(sourceName: String, targetName: String)] = [
            ("webviews-app", "coterm-webviews-app"),
            ("diff-viewer-app", "coterm-diff-viewer-app")
        ]
        for candidate in candidates {
            ...
            if FileManager.default.fileExists(atPath: appDirectory.path, isDirectory: &isDirectory),
               ...
               FileManager.default.fileExists(atPath: entry.path) {
                // The shared /tmp asset cache is written by every running coterm
        ...
        throw CLIError(message: "Bundled coterm diff viewer app assets not found")
    }
    ...
    private func diffViewerBundledAssetDirectoryCandidates(runtime: URL? = nil) -> [URL] {
        ...
        if let executableURL = diffViewerExecutableURL(for: runtime) {
            ...
            for _ in 0..<6 {
                ...
                let projectMarker = current.appendingPathComponent("coterm.xcodeproj/project.pbxproj", isDirectory: false)
    ...
    func openSubcommandUsage() -> String {
        """
        Usage: coterm open <path-or-url>... [options]

        Open files, directories, or URLs in coterm.
        ...
        Options:
          --workspace <id|ref|index>   Target workspace (default: $COTERM_WORKSPACE_ID)
          --surface <id|ref|index>     Target surface whose pane should receive file tabs (default: $COTERM_SURFACE_ID)
        ...
        Examples:
          coterm open report.pdf
          coterm open image-a.png image-b.jpg
          coterm open ~/Downloads/movie.mov --pane pane:1
          coterm open https://example.com
        """
    }

    func diffSubcommandUsage() -> String {
        """
        Usage: coterm diff [patch-file|-] [options]

        Render a unified diff or patch in a Coterm browser split.
        With no patch file or source, coterm diff reads piped stdin.
        ...
        Options:
          ...
          --workspace <id|ref|index>   Target workspace (default: $COTERM_WORKSPACE_ID)
          --surface <id|ref|index>     Source surface to split from (default: $COTERM_SURFACE_ID)
          ...
          --layout <split|unified>     Diff layout (default: unified; configurable via diffViewer.defaultLayout in coterm.json)
          --font-size <points>         Set diff font size (default: 10)

        Examples:
          coterm diff changes.patch
          git diff | coterm diff
          coterm diff --unstaged
          coterm diff --staged
          coterm diff --branch
          coterm diff --branch --base upstream/main --repo ../repo
          coterm diff --last-turn
          coterm diff pr.patch --layout unified --font-size 15 --focus true
        """
    }
