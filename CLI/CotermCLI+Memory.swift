...
extension CotermCLI {
    ...
    private func buildMemoryPayload(
        ...
        do {
            ...
            throw CLIError(message: String(localized: "cli.memory.error.diagnosticsUnsupported", defaultValue: "coterm memory requires a running coterm build that supports memory diagnostics"))
        }
    }
    ...
    private func renderMemoryText(
        ...
        lines.append("  \(appName.isEmpty ? "coterm" : appName) pid=\(appPID)")
