...
A `.swift` file added to `cotermTests/` without matching project entries can be silently ignored by Xcode. Both targeted `xcodebuild test -only-testing:cotermTests/<TestClass>` and bot reviews can pass with "Executed 0 tests".
