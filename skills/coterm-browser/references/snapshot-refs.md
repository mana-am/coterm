...
```bash
Coterm browser surface:7 snapshot
Coterm browser surface:7 snapshot --interactive
Coterm browser surface:7 snapshot --interactive --compact --max-depth 3
```

## Using Refs

```bash
Coterm browser surface:7 click e6
Coterm browser surface:7 fill e10 "user@example.com"
Coterm browser surface:7 fill e11 "password123"
Coterm browser surface:7 click e12
```
...
Coterm browser surface:7 click e1
...
```bash
Coterm browser surface:7 wait --selector "#target" --timeout-ms 10000
Coterm browser surface:7 scroll --dy 400
Coterm browser surface:7 snapshot --interactive
```
...
```bash
Coterm browser surface:7 snapshot --selector "form#checkout" --interactive
```
