---
name: coterm-browser
description: End-user browser automation with coterm. Use when you need to open sites, interact with pages, wait for state changes, and extract data from Coterm browser surfaces.
---

# Browser Automation with coterm

Use this skill for browser tasks inside coterm webviews.
...
```bash
coterm --json browser open https://example.com
# use returned surface ref, for example: surface:7

Coterm browser surface:7 get url
Coterm browser surface:7 wait --load-state complete --timeout-ms 15000
Coterm browser surface:7 snapshot --interactive
Coterm browser surface:7 fill e1 "hello"
coterm --json browser surface:7 click e2 --snapshot-after
Coterm browser surface:7 snapshot --interactive
```
...
Coterm browser open https://example.com --workspace workspace:2 --window window:1 --json
```
...
coterm supports wait patterns similar to agent-browser:

```bash
Coterm browser <surface> wait --selector "#ready" --timeout-ms 10000
Coterm browser <surface> wait --text "Success" --timeout-ms 10000
...
```bash
coterm --json browser open https://example.com/signup
Coterm browser surface:7 get url
Coterm browser surface:7 wait --load-state complete --timeout-ms 15000
Coterm browser surface:7 snapshot --interactive
Coterm browser surface:7 fill e1 "Jane Doe"
Coterm browser surface:7 fill e2 "jane@example.com"
coterm --json browser surface:7 click e3 --snapshot-after
Coterm browser surface:7 wait --url-contains "/welcome" --timeout-ms 15000
Coterm browser surface:7 snapshot --interactive
```
...
```bash
Coterm browser surface:7 fill e11 "" --snapshot-after --json
Coterm browser surface:7 get value e11 --json
```
...
Coterm browser surface:7 wait --load-state complete --timeout-ms 15000
Coterm browser surface:7 snapshot --interactive
coterm --json browser surface:7 click e5 --snapshot-after
Coterm browser surface:7 snapshot --interactive
```
...
```bash
Coterm browser surface:7 get url
Coterm browser surface:7 get text body
Coterm browser surface:7 get html body
```
