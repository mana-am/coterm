# Command Reference (coterm Markdown)

## Opening a Markdown Panel

```bash
coterm markdown open <path>
coterm markdown <path>          # shorthand (implicit "open")
```
...
|------|-------------|---------|
| `--workspace <id\|ref\|index>` | Target workspace | `$COTERM_WORKSPACE_ID` |
...
coterm markdown open ./plan.md
coterm markdown open /Users/me/project/plan.md
```
