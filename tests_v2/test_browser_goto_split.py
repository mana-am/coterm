...
def _wait_focused(client: coterm, expected_pane_id: str, timeout_s: float = 6.0) -> Optional[str]:
...
def _wait_url_loaded(client: coterm, browser_id: str, timeout_s: float = 10.0) -> str:
