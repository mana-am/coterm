...
private let pushLog = Logger(subsystem: "ai.emergent.inc.coterm", category: "push")

/// Owns the push opt-in state and the device-token sync with the coterm web API.
///
...
public actor PushRegistrationService: PushRegistering {
    ...
    private static let cachedTokenKey = "coterm.notifications.deviceTokenHex"
