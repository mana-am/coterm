...
public struct CotermAuthState: Equatable, Sendable {
    /// Whether a user session is currently active.
    public let isAuthenticated: Bool
    /// The signed-in (or cached) user, if any.
    public let currentUser: CotermAuthUser?
    ...
    public init(isAuthenticated: Bool, currentUser: CotermAuthUser?, isRestoringSession: Bool) {
    ...
    public static func primed(
        ...
        fixtureUser: CotermAuthUser?,
        autoLoginCredentials: CotermAuthAutoLoginCredentials?,
        cachedUser: CotermAuthUser?,
        hasTokens: Bool,
        mockUser: CotermAuthUser
    ) -> Self {
