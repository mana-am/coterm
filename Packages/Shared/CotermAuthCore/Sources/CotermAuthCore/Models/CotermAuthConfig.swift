...
public struct CotermAuthConfig: Equatable, Sendable {
    ...
    ///     injected defaults.
    ///   - developmentProjectId: Default project id for ``CotermAuthEnvironment/development``.
    ///   - productionProjectId: Default project id for ``CotermAuthEnvironment/production``.
