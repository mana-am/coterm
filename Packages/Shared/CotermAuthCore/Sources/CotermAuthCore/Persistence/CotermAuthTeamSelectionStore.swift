...
///
/// Backed by an injected ``CotermAuthKeyValueStore`` (production: `UserDefaults`)
...
/// thread-safe, matching ``CotermAuthSessionCache`` and ``CotermAuthIdentityStore``.
public final class CotermAuthTeamSelectionStore: @unchecked Sendable {
