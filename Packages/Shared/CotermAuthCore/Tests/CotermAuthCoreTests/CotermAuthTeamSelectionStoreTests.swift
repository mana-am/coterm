...
@Suite struct CotermAuthTeamSelectionStoreTests {
    @Test func roundTripsSelection() {
        let store = CotermAuthTeamSelectionStore(
    ...
    @Test func nilAssignmentAndClearRemoveValue() {
        ...
        let store = CotermAuthTeamSelectionStore(keyValueStore: backing, key: "selected_team")
        store.selectedTeamID = "team_a"
...
private final class SelectionTestKeyValueStore: CotermAuthKeyValueStore {
