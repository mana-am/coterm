...
public struct ChatSessionDescriptor: Identifiable, Sendable, Equatable, Codable {
    ...
    /// The coterm workspace the session's terminal belongs to, when known.
    public let workspaceID: String?

    /// The coterm terminal surface hosting the session, when known. Required
    ...
    ///   - workspaceID: Owning coterm workspace when known.
    ///   - terminalID: Hosting coterm terminal surface when known.
