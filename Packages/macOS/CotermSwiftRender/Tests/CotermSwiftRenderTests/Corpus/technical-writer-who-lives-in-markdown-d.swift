HSplitView {
    ...
    VStack(alignment: .leading, spacing: 10) {
        ...
        .padding(4)
        .onTapGesture { coterm("writer.sprint.toggle", minutes: 25) }
        ...
        HStack(spacing: 8) {
            Button("＋ Section") { coterm("writer.insert", snippet: "## ") }
                .font(.caption).foregroundColor("#7AA2F7")
            Button("Frontmatter") { coterm("writer.insert", snippet: "frontmatter") }
                .font(.caption).foregroundColor("#7AA2F7")
        }
        .padding(4)
    }
    ...
    VStack(alignment: .leading, spacing: 12) {
        ...
        Button(action: { coterm("writer.format") }) {
            HStack(spacing: 6) {
        ...
        Button(action: { coterm("writer.preview") }) {
            HStack(spacing: 6) {
        ...
        Button(action: { coterm("writer.commit", message: "docs: writing session") }) {
            HStack(spacing: 6) {
        ...
        if lintClean {
            Button(action: { coterm("writer.publish") }) {
                HStack(spacing: 6) {
