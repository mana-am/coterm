...
///
/// Stable releases ship with the stable appcast URL and `coterm NIGHTLY` has the nightly
...
public struct UpdateFeedResolver: Sendable {
    ...
    public init(fallbackFeedURL: String = "https://updates.coterm.cc/stable/appcast.xml") {
