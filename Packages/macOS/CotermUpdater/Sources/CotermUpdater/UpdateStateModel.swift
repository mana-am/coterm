...
/// Observation framework; appearance (color) derivations live in the `CotermUpdaterUI` package.
///
...
public final class UpdateStateModel {
    ...
    private static let lastAutoPromptedVersionKey = "CotermUpdater.lastAutoPromptedVersion"
    ...
    public func debugShowUpdateError(_ scenario: DebugUpdateErrorScenario) {
        setOverrideState(.error(.init(
            ...
            feedURLString: "https://updates.coterm.cc/stable/appcast.xml"
        )))
    }
    #endif
