...
///
/// DEBUG-only test scaffolding. The feed contents are driven by `COTERM_UI_TEST_*` environment
/// variables.
final class UpdateTestURLProtocol: URLProtocol {
    static let host = "coterm.test"
    static let appcastPath = "/appcast.xml"
    static let updatePath = "/coterm-test.zip"
    ...
    private static func appcastData() -> Data {
        ...
        let mode = env["COTERM_UI_TEST_FEED_MODE"] ?? "available"
        ...
        <rss version="2.0"
          ...
          <channel>
            <title>coterm Test Updates</title>
