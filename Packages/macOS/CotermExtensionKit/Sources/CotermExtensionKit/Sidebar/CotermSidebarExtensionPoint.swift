...
/// Public identifiers for the COTERM sidebar ExtensionKit surface.
@_spi(CotermHostTransport)
public enum CotermSidebarExtensionPoint {
    ...
    ///
    /// Populated at build time from the `COTERM_SIDEBAR_EXTENSION_POINT_ID` build setting
    ...
    public static let identifierInfoPlistKey = "CotermSidebarExtensionPointIdentifier"
    ...
    /// Default ExtensionKit scene identifier hosted inside the coterm sidebar.
