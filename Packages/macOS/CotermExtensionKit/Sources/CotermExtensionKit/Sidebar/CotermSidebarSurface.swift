...
/// The user-visible kind of a coterm sidebar surface.
public enum CotermSidebarSurfaceKind: String, Codable, CaseIterable, Equatable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self = CotermSidebarSurfaceKind(rawValue: rawValue) ?? .unknown
    }
}

/// A sidebar surface exposed to coterm extensions.
public struct CotermSidebarSurface: Codable, Equatable, Identifiable, Sendable {
    /// The stable surface identifier.
    public var id: UUID
    /// The current surface title.
    public var title: String
    /// The kind of surface.
    public var kind: CotermSidebarSurfaceKind
    ...
    public init(
        id: UUID,
        title: String,
        kind: CotermSidebarSurfaceKind = .unknown,
    ...
    public func filtered(for scopes: some Sequence<CotermExtensionScope>) -> CotermSidebarSurface {
