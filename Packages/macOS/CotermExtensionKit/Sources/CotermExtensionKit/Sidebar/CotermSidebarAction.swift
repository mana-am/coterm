...
public enum CotermSidebarSplitDirection: String, Codable, CaseIterable, Equatable, Sendable {
    case left
    case right
    case up
    case down
...
public enum CotermSidebarAction: Codable, Equatable, Sendable {
    ...
    case splitTerminal(workspaceID: UUID, surfaceID: UUID, direction: CotermSidebarSplitDirection)
    case splitBrowser(workspaceID: UUID, surfaceID: UUID, direction: CotermSidebarSplitDirection, url: String?)
    case toggleSurfaceZoom(workspaceID: UUID, surfaceID: UUID)
    case openURL(String)

    public var requiredScopes: Set<CotermExtensionActionScope> {
        switch self {
