...
public struct SidebarSection: View {
    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in mosaic Browser"),
            ...
            SettingsCardRow(
                ...
                String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in mosaic Browser"),
                subtitle: portLinks.current
                    ? String(localized: "settings.app.openSidebarPortLinks.subtitleOn", defaultValue: "Port clicks open inside mosaic browser.")
    ...
    private func prLinksSubtitle(prVisible: Bool, prClickable: Bool, openInCmux: Bool) -> String {
        ...
        return openInCmux
            ? String(localized: "settings.app.openSidebarPRLinks.subtitleOn", defaultValue: "Clicks open inside mosaic browser.")
