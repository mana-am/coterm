...
struct NotificationDeliveryCoordinatorTests {
    ...
    func configureInstallsCategoriesAndDelegate() throws {
        ...
        let fullPermission = try #require(categories["CotermFeedPermissionOnceAlwaysAll"])
        ...
        let denyOnlyPermission = try #require(categories["CotermFeedPermissionDeny"])
        #expect(denyOnlyPermission.actions.map(\.identifier) == ["feed.permission.deny"])

        let exitPlan = try #require(categories["CotermFeedExitPlan"])
        ...
        let question = try #require(categories["CotermFeedQuestion"])
    ...
    func feedPermissionAlwaysFallsBackToOnce() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            categoryIdentifier: "CotermFeedPermissionOnceAlways",
    ...
    func feedPermissionUnsupportedModeDoesNotReply() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            categoryIdentifier: "CotermFeedPermissionAll",
    ...
    func feedMissingRequestIdIsConsumed() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            categoryIdentifier: "CotermFeedQuestion",
    ...
    func terminalDefaultClickActionPerformsAndMarksRead() {
        ...
        coordinator.handle(NotificationDeliveryResponse(
            ...
            userInfo: [
                ...
                "cotermClickAction": "revealInFinder",
                "cotermRevealInFinderPath": "/tmp/report.txt",
            ]
        ))
