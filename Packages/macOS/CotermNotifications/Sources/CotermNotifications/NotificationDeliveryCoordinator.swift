...
public final class NotificationDeliveryCoordinator {
    ...
    func notificationCategories() -> Set<UNNotificationCategory> {
        ...
        let permissionCategories = feedPermissionNotificationCategoryIds().map { categoryId in
            ...
            if categoryId.contains("Once") || categoryId == "CotermFeedPermission" {
                actions.append(permissionOnceAction)
            }
            if categoryId.contains("Always") || categoryId == "CotermFeedPermission" {
    ...
    private func feedPermissionNotificationCategoryIds() -> [String] {
        [
            "CotermFeedPermission",
            "CotermFeedPermissionDeny",
            "CotermFeedPermissionOnce",
            "CotermFeedPermissionAlways",
            "CotermFeedPermissionAll",
            "CotermFeedPermissionOnceAlways",
            "CotermFeedPermissionOnceAll",
            "CotermFeedPermissionAlwaysAll",
            "CotermFeedPermissionOnceAlwaysAll",
        ]
    }
    ...
    private func handleFeedNotificationResponse(_ response: NotificationDeliveryResponse) -> Bool {
        ...
        guard categoryId.hasPrefix("CotermFeedPermission")
