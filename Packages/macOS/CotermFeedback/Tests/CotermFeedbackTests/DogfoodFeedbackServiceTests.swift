...
@testable import CotermFeedback
...
struct DogfoodFeedbackServiceTests {
    private func makeService(
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-dogfood-test-\(UUID().uuidString)", isDirectory: true)
    ...
    func writesBundle() async throws {
        ...
        #expect(manifest?["schema"] as? String == "coterm.dogfood.feedback.v1")
    ...
    func prunesOldBundles() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-dogfood-prune-\(UUID().uuidString)", isDirectory: true)
