...
/// key, the upload endpoint (env-overridable), size limits, and the support
...
public struct FeedbackComposerSettings: Sendable, Equatable {
    ...
    public init(
        ...
        endpointEnvironmentKey: String = "COTERM_FEEDBACK_API_URL",
        defaultEndpoint: String = "https://coterm.cc/api/feedback",
