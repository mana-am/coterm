...
struct DSLAction: Codable, Equatable, Sendable {
    ...
    /// - any other `type` is treated as a coterm dispatcher method
    ///   (``ActionCommand/coterm(method:params:)`` with no params).
    var buttonAction: ButtonAction {
        ...
        default:
            return ButtonAction(commands: [.coterm(method: type, params: [:])])
        }
    }
}
