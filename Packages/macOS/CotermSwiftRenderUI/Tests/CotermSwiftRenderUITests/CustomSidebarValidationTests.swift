...
import Foundation
import Testing
@testable import CotermSwiftRenderUI
...
struct CustomSidebarValidationTests {
    ...
    private func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-sidebar-validation-\(UUID().uuidString)", isDirectory: true)
    ...
    private static let richSidebarContext: [String: SwiftValue] = [
        ...
        "selectedTitle": .string("coterm"),
        "selectedId": .string("workspace-coterm"),
        "unreadTotal": .int(4),
        "clock": .object([
        ...
        "workspaces": .array([
            .object([
                "id": .string("workspace-coterm"),
                "title": .string("coterm"),
                "selected": .bool(true),
                "pinned": .bool(true),
                "index": .int(0),
                "directory": .string("/Users/me/src/coterm"),
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/emergent-inc/coterm/pull/5812"),
                    "status": .string("open"),
                    "stale": .bool(false),
                    "branch": .string("fix-crash-on-launch"),
                ]),
                ...
                "tabs": .array([
                    ...
                    .object([
                        ...
                        "focused": .bool(false),
                        "pinned": .bool(true),
                        "directory": .string("/Users/me/src/coterm/web"),
                        "branch": .string("fix-crash-on-launch"),
                        "dirty": .bool(false),
            ...
            .object([
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/emergent-inc/coterm/pull/5801"),
