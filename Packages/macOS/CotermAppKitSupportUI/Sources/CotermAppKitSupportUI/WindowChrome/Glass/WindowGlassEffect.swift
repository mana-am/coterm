...
public final class WindowGlassEffect: WindowGlassEffectManaging {
    static let backgroundIdentifier = NSUserInterfaceItemIdentifier("coterm.windowGlassBackground")
    static let rootIdentifier = NSUserInterfaceItemIdentifier("coterm.windowGlassRoot")
    static let foregroundContainerViewIdentifier = NSUserInterfaceItemIdentifier("coterm.windowGlassForeground")
