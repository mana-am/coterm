...
public enum CmuxSidebarExtensionPoint {
    ...
    /// per build tag (e.g. `mosaic.com.emergent.app.debug.my-tag.cmux.sidebar`) so that concurrent debug
    ...
    /// committed to source.
    public static let baseIdentifier = "mosaic.com.emergent.app.cmux.sidebar"
