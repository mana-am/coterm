...
struct RovoDevSessionResolverTests {
    ...
    func rejectsMissingAndNonExactCwd() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-rovo-resolver-\(UUID().uuidString)", isDirectory: true)
        ...
        let env = ["COTERM_ROVODEV_SESSIONS_DIR": sessionsRoot.path]
    ...
    func infersNewestMatchingWorkspaceSession() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-rovo-resolver-newest-\(UUID().uuidString)", isDirectory: true)
    ...
    func matchesSymlinkedWorkspacePaths() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-rovo-resolver-symlink-\(UUID().uuidString)", isDirectory: true)
