    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text(String(localized: "update.popover.autoUpdatesDescription", defaultValue: "coterm can automatically check for updates in the background."))
                    .cotermFont(size: 11)
                    .foregroundColor(.secondary)
