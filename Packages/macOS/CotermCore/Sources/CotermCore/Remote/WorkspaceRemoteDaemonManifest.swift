...
/// The release manifest describing downloadable cotermd-remote daemon binaries
...
public struct WorkspaceRemoteDaemonManifest: Decodable, Equatable, Sendable {
    ...
    /// coterm app version the manifest was generated for.
...
extension WorkspaceRemoteDaemonManifest {
    ...
    /// JSON (`CotermRemoteDaemonManifestJSON`); wire-pinned.
    public static let infoDictionaryKey = "CotermRemoteDaemonManifestJSON"
