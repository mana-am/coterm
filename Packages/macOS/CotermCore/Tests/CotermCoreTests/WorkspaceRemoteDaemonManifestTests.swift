...
struct WorkspaceRemoteDaemonManifestTests {
    private let manifestJSON = """
    {
      "schemaVersion": 1,
      "appVersion": "0.20.0",
      "releaseTag": "cotermd-remote-v0.20.0",
      "releaseURL": "https://github.com/emergent-inc/coterm/releases/tag/cotermd-remote-v0.20.0",
      ...
      "entries": [
        {
          ...
          "downloadURL": "https://example.invalid/cotermd-remote-linux-amd64",
          "sha256": "abc123"
        },
        {
          "goOS": "darwin",
          "goArch": "arm64",
          "assetName": "cotermd-remote-darwin-arm64",
          "downloadURL": "https://example.invalid/cotermd-remote-darwin-arm64",
          "sha256": "def456"
        }
      ]
    }
    ...
    func entryLookup() throws {
        ...
        #expect(manifest.entry(goOS: "darwin", goArch: "arm64")?.assetName == "cotermd-remote-darwin-arm64")
    ...
    func decodesFromInfoDictionary() throws {
        ...
        #expect(WorkspaceRemoteDaemonManifest.infoDictionaryKey == "CotermRemoteDaemonManifestJSON")
        #expect(manifest.releaseTag == "cotermd-remote-v0.20.0")
