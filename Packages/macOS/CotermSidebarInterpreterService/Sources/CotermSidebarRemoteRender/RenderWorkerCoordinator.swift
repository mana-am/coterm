...
final class RenderWorkerCoordinator {
    ...
    /// Stderr diagnostics, enabled with `COTERM_RENDER_WORKER_DEBUG=1` in the
    ...
    private let debugEnabled = ProcessInfo.processInfo.environment["COTERM_RENDER_WORKER_DEBUG"] == "1"
