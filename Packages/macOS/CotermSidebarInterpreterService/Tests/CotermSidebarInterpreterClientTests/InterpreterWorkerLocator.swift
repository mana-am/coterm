...
/// Locates the built `coterm-sidebar-interpreter` worker executable so the client
...
func interpreterWorkerURL() -> URL {
    builtExecutableURL(named: "coterm-sidebar-interpreter")
}

/// Locates the built `coterm-sidebar-render-fixture` protocol fixture for the
/// `RenderWorkerClient` supervision tests (same lookup rules as the worker).
func renderFixtureURL() -> URL {
    builtExecutableURL(named: "coterm-sidebar-render-fixture")
}
...
private func builtExecutableURL(named workerName: String) -> URL {
    ...
    // <package>/Tests/CotermSidebarInterpreterClientTests/<thisFile>
