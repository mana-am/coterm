...
///
/// The default values are the exact strings the coterm v2 browser RPC wire format
...
public struct BrowserEvalEnvelope: Sendable, Equatable {
    ...
    /// - Parameters:
    ///   - typeKey: JSON key for the discriminator. Defaults to the wire value `"__coterm_t"`.
    ///   - valueKey: JSON key for the payload. Defaults to the wire value `"__coterm_v"`.
    ...
    public init(
        typeKey: String = "__coterm_t",
        valueKey: String = "__coterm_v",
