...
/// One mapping in an import plan: a set of source profiles and the coterm
...
public struct BrowserImportExecutionEntry: Equatable, Sendable {
    ...
    /// The coterm destination profile request for this entry.
    ...
    ///   - destination: The coterm destination profile request.
