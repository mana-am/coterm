...
/// scope and domain filters, any coterm profiles created, and the per-mapping
/// outcome entries.
public struct BrowserImportOutcome: Sendable {
    ...
    /// Display names of coterm profiles created during this import.
    ...
    ///   - createdDestinationProfileNames: Names of coterm profiles created.
    ...
    /// JSON-serializable representation sent over the coterm automation socket.
