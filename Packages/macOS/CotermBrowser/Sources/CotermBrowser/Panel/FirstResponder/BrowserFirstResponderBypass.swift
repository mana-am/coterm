...
///
/// Faithfully lifted from the app target's `cotermWindowFirstResponderBypassDepth`
/// global plus the `cotermWithWindowFirstResponderBypass` /
/// `cotermIsWindowFirstResponderBypassActive` free functions. The depth counter
