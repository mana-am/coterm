...
Strongly-typed, migratable settings storage for mosaic. Foundation-only.

## Overview

`MosaicSettings` is the settings layer of mosaic. It is built on three
principles:
