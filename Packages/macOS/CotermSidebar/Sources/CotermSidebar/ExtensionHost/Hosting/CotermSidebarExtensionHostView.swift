...
@_spi(CotermHostTransport) public import CotermExtensionKit
public import Foundation
public import SwiftUI

@available(macOS 14.0, *)
/// SwiftUI bridge that hosts a sidebar extension scene through ExtensionKit.
@_spi(CotermHostTransport) public struct CotermSidebarExtensionHostView: NSViewControllerRepresentable {
    ...
    @_spi(CotermHostTransport) public final class Coordinator: NSObject, EXHostViewControllerDelegate {
    ...
    public init(
        ...
        sceneID: String = CotermSidebarExtensionPoint.defaultSceneID,
