...
public struct SidebarMultiSelectionShouldCollapseEvent: Sendable {
    /// The legacy notification name (`coterm.sidebarMultiSelectionShouldCollapse`).
    public static let notificationName = Notification.Name("coterm.sidebarMultiSelectionShouldCollapse")
