...
public struct SidebarMultiSelectionDidHideEvent: Sendable {
    /// The legacy notification name (`coterm.sidebarMultiSelectionDidHide`).
    public static let notificationName = Notification.Name("coterm.sidebarMultiSelectionDidHide")
