...
/// mosaic, Terminal Config link, Open Markdown in mosaic Viewer,
...
public struct AppSection: View {
    ...
    public init(
        ...
        _openSupported = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.app.openSupportedFilesInMosaic))
        _openMarkdown = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.app.openMarkdownInMosaicViewer))
    ...
    private var globalFontMagnificationSubtitle: String {
        ...
        return String(
            ...
            defaultValue: "Scale every font in mosaic by the same percentage. 100% = design size."
        )
    }
        ...
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                subtitle: languageAtAppear != nil && language.current != languageAtAppear
                    ? String(localized: "settings.app.language.restartSubtitle", defaultValue: "Restart mosaic to apply")
                    : nil,
            ...
            SettingsCardRow(
                ...
                subtitle: firstClick.current
                    ? String(localized: "settings.app.paneFirstClickFocus.subtitleOn", defaultValue: "When mosaic is inactive, clicking a pane activates the window and focuses that pane in one click.")
                    : String(localized: "settings.app.paneFirstClickFocus.subtitleOff", defaultValue: "When mosaic is inactive, the first click only activates the window. Click again to focus the pane.")
            ) {
            ...
            // Open Supported Files in mosaic
            SettingsCardRow(
                configurationReview: .json("app.openSupportedFilesInMosaic"),
                String(localized: "settings.app.openSupportedFilesInMosaic", defaultValue: "Open Supported Files in mosaic"),
                subtitle: String(localized: "settings.app.openSupportedFilesInMosaic.subtitle", defaultValue: "Cmd-clicking readable files opens text, code, PDFs, images, audio, video, and Quick Look previews in mosaic.")
            ) {
            ...
            // Open Markdown in mosaic Viewer
            SettingsCardRow(
                configurationReview: .json("app.openMarkdownInMosaicViewer"),
                String(localized: "settings.app.openMarkdownInMosaicViewer", defaultValue: "Open Markdown in mosaic Viewer"),
                subtitle: String(localized: "settings.app.openMarkdownInMosaicViewer.subtitle", defaultValue: "When supported file routing is on, Cmd-clicking Markdown files opens the rendered mosaic markdown viewer instead of the generic file preview.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.menuBarOnly.subtitle", defaultValue: "Hide the Dock icon and Cmd+Tab entry. Use the menu bar item to show mosaic.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.showInMenuBar.subtitle", defaultValue: "Keep mosaic in the menu bar for unread notifications and quick actions.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.notifications.paneFlash.subtitle", defaultValue: "Briefly flash a blue outline when mosaic highlights a pane.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.notifications.command.subtitle", defaultValue: "Run a shell command when a notification arrives. $MOSAIC_NOTIFICATION_TITLE, $MOSAIC_NOTIFICATION_SUBTITLE, $MOSAIC_NOTIFICATION_BODY are set.")
            ) {
                TextField(
            ...
            SettingsCardRow(
                ...
                subtitle: (telemetryAtAppear != nil && telemetry.current != telemetryAtAppear)
                    ...
                    : String(localized: "settings.app.telemetry.subtitle", defaultValue: "Share anonymized crash and usage data to help improve mosaic.")
            ) {
    ...
    /// Standard macOS notification sound names plus mosaic-specific
