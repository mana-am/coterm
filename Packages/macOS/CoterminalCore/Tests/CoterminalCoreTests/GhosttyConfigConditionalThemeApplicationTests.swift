...
/// Regression coverage for https://github.com/emergent-inc/coterm/issues/6411.
///
/// coterm paints the terminal background from its host layer
...
/// cross-side fell back to the other appearance's theme, coterm painted a light
...
@Suite struct GhosttyConfigConditionalThemeApplicationTests {
    ...
    private func makeThemesRoot() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("coterm-6411-\(UUID().uuidString)", isDirectory: true)
