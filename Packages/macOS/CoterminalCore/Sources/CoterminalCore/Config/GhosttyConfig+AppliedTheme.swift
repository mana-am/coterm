...
extension GhosttyConfig {
    ...
    /// coterm painted a light theme's near-white background under Ghostty's default
    /// near-white foreground in the mismatched appearance — the unreadable
    /// white-on-white regression in
    /// https://github.com/emergent-inc/coterm/issues/6411. Resolving the same way the
