/// A per-window coterm configuration store that can re-read its backing file.
///
/// The app target's `CotermConfigStore` conforms to this so
/// `CotermConfigStoreReloadCoordinator` can drive reloads without depending on the
...
@MainActor
public protocol CotermConfigStoreReloading: AnyObject {
...
@MainActor
public protocol CotermConfigStoreReloadEnvironment: AnyObject {
    ...
    var reloadableConfigStores: [any CotermConfigStoreReloading] { get }
