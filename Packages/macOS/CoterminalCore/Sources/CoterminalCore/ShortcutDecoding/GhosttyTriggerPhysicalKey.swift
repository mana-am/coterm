...
/// keys coterm maps to a menu-style shortcut glyph.
///
...
/// package without importing GhosttyKit. Any Ghostty physical key coterm does not
...
public enum GhosttyTriggerPhysicalKey: String, Sendable, Equatable, Hashable, CaseIterable {
    ...
    /// The menu-style glyph coterm renders for this physical key.
    ///
