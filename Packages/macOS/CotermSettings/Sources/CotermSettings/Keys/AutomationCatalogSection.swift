...
public struct AutomationCatalogSection: SettingCatalogSection {
    ...
    /// content. Default off: enabling it lets coterm run the user's own agent
    ...
    public let portBase = DefaultsKey<Int>(
        ...
        defaultValue: 9100,
        userDefaultsKey: "cotermPortBase"
    )

    public let portRange = DefaultsKey<Int>(
        id: "automation.portRange",
        defaultValue: 10,
        userDefaultsKey: "cotermPortRange"
    )
