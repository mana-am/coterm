...
public struct BrowserCatalogSection: SettingCatalogSection {
    ...
    public let openTerminalLinksInCotermBrowser = DefaultsKey<Bool>(
        id: "browser.openTerminalLinksInCotermBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenTerminalLinksInCotermBrowser"
    )

    public let interceptTerminalOpenCommandInCotermBrowser = DefaultsKey<Bool>(
        id: "browser.interceptTerminalOpenCommandInCotermBrowser",
        defaultValue: true,
        userDefaultsKey: "browserInterceptTerminalOpenCommandInCotermBrowser"
    )
    ...
    /// "Enable coterm Browser" toggle was a no-op until this was aligned.)
