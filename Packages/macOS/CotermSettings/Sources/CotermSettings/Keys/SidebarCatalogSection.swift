...
public struct SidebarCatalogSection: SettingCatalogSection {
    ...
    /// shipped coterm build; using an enum here would silently revert
    ...
    public let openPullRequestLinksInCotermBrowser = DefaultsKey<Bool>(
        id: "sidebar.openPullRequestLinksInCotermBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenSidebarPullRequestLinksInCotermBrowser"
    )

    public let openPortLinksInCotermBrowser = DefaultsKey<Bool>(
        id: "sidebar.openPortLinksInCotermBrowser",
        defaultValue: true,
        userDefaultsKey: "browserOpenSidebarPortLinksInCotermBrowser"
    )
