...
/// The stable, user-customisable shortcut actions coterm exposes.
///
...
/// identifier persisted in coterm.json.
...
extension ShortcutAction {
    ...
    ///
    /// Most coterm-owned shortcuts require a modifier on the first stroke to avoid
