...
Strongly-typed, migratable settings storage for coterm. Foundation-only.

## Overview

`CotermSettings` is the settings layer of coterm. It is built on three
principles:
