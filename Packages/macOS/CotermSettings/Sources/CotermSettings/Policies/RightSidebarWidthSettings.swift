...
public struct RightSidebarWidthSettings: Sendable {
    ...
    /// The `coterm.json` key under `sidebar` that stores the right sidebar maximum width.
    ...
    /// The largest width accepted by settings editors and imported `coterm.json` values.
