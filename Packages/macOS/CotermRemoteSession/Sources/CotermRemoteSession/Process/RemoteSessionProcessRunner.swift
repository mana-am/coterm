...
public struct RemoteSessionProcessRunner: RemoteSessionProcessRunning {
    ...
    public func run(
        ...
        let captureQueue = DispatchQueue(label: "coterm.remote.process.capture")
        ...
        do {
            ...
            throw NSError(domain: "coterm.remote.process", code: 1, userInfo: [
        ...
        if !didExitBeforeTimeout, process.isRunning {
            ...
            throw NSError(domain: "coterm.remote.process", code: 2, userInfo: [
