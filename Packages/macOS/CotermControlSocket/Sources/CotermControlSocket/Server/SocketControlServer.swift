...
/// The coterm control-socket listener: path reservation, bind/listen lifecycle,
...
public final class SocketControlServer {
    ...
    struct ListenerState {
        ...
        var accessMode: SocketControlMode = .cotermOnly
    }
    ...
    nonisolated let socketListenerQueue = DispatchQueue(label: "com.coterm.socket.listener")
