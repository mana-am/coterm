...
public enum ControlPaneCreateResolution: Sendable, Equatable {
    ...
    /// A browser split was requested while the Coterm browser is disabled and an
    ...
    /// A browser split was requested while the Coterm browser is disabled and no
    /// URL was supplied (legacy `browser_disabled` / "Coterm browser is
    /// disabled", `data: nil`).
    case browserDisabledNoURL
    /// A browser split was requested while the Coterm browser is disabled and the
