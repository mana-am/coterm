...
public struct CotermSidebarProviderIcon: Codable, Equatable, Sendable {
    ...
    /// Background shape.
    public var shape: CotermSidebarProviderIconShape
    ...
    public init(
        ...
        shape: CotermSidebarProviderIconShape = .circle
    ) {
