...
public struct CotermSidebarProviderWorkspace: Identifiable, Codable, Equatable, Sendable {
    /// Workspace id.
    public var id: UUID
    /// Display title.
    ...
    public var gitBranches: [CotermSidebarProviderGitBranch]
    ...
    public init(
        ...
        gitBranches: [CotermSidebarProviderGitBranch] = []
    ) {
        self.id = id
        self.title = title
