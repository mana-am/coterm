internal import CotermRemoteDaemon
...
extension RemotePTYBridgeServer {
    ...
    final class Session: @unchecked Sendable {
        ...
        private let rpcQueue = DispatchQueue(label: "com.coterm.remote-ssh.pty-bridge.rpc.\(UUID().uuidString)", qos: .userInitiated)
        ...
        func userFacingBridgeErrorMessage(_ error: any Error) -> String {
            ...
            // See https://github.com/emergent-inc/coterm/issues/5185.
