...
@Suite struct PullRequestProbeServiceTests {
    private func item(
        number: Int,
        state: String,
        url: String = "https://github.com/emergent-inc/coterm/pull/1",
        updatedAt: String?,
        mergedAt: String? = nil,
    ...
    @Test func preferredPullRequestPrefersOpenOverMergedAndClosed() {
        let candidates = [
            item(number: 1889, state: "MERGED", url: "https://github.com/emergent-inc/coterm/pull/1889", updatedAt: "2026-03-20T18:00:00Z"),
            item(number: 1891, state: "OPEN", url: "https://github.com/emergent-inc/coterm/pull/1891", updatedAt: "2026-03-19T18:00:00Z"),
            item(number: 1800, state: "CLOSED", url: "https://github.com/emergent-inc/coterm/pull/1800", updatedAt: "2026-03-21T18:00:00Z"),
        ]
    ...
    @Test func preferredPullRequestPrefersMostRecentlyUpdatedWithinSameStatus() {
        let olderOpen = item(number: 1880, state: "OPEN", url: "https://github.com/emergent-inc/coterm/pull/1880", updatedAt: "2026-03-18T18:00:00Z")
        let newerOpen = item(number: 1890, state: "OPEN", url: "https://github.com/emergent-inc/coterm/pull/1890", updatedAt: "2026-03-20T18:00:00Z")
    ...
    @Test func preferredPullRequestIgnoresMalformedCandidates() {
        let valid = item(number: 1888, state: "OPEN", url: "https://github.com/emergent-inc/coterm/pull/1888", updatedAt: "2026-03-20T18:00:00Z")
        let preferred = PullRequestProbeService.preferredPullRequest(from: [
            item(number: 9999, state: "WHATEVER", url: "https://github.com/emergent-inc/coterm/pull/9999", updatedAt: "2026-03-21T18:00:00Z"),
    ...
    @Test func pullRequestMapDropsStaleMergedHeadPullRequestForLongLivedBaseBranch() throws {
        ...
        let pullRequests = [
            item(number: 2400, state: "MERGED", url: "https://github.com/emergent-inc/coterm/pull/2400", updatedAt: "2026-03-06T12:00:00Z", mergedAt: "2026-03-06T12:00:00Z", headRefName: "develop", baseRefName: "main"),
            item(number: 2501, state: "MERGED", url: "https://github.com/emergent-inc/coterm/pull/2501", updatedAt: "2026-04-19T12:00:00Z", mergedAt: "2026-04-19T12:00:00Z", headRefName: "feature/recent-one", baseRefName: "develop"),
            item(number: 2502, state: "OPEN", url: "https://github.com/emergent-inc/coterm/pull/2502", updatedAt: "2026-04-20T12:00:00Z", headRefName: "feature/recent-two", baseRefName: "develop"),
        ]
    ...
    @Test func decodesRESTItemsAndSynthesizesMergedState() throws {
        ...
        [
          {
            "number": 5277,
            "state": "closed",
            "html_url": "https://github.com/emergent-inc/coterm/pull/5277",
            "updated_at": "2026-06-03T10:00:00Z",
            "merged_at": "2026-06-03T10:00:00Z",
            "head": {"ref": "feat-coterm-git"},
            "base": {"ref": "main"}
          },
          {
            "number": 5293,
            "state": "open",
            "html_url": "https://github.com/emergent-inc/coterm/pull/5293",
        ...
        #expect(items[0].headRefName == "feat-coterm-git")
        ...
        #expect(items[1].url == "https://github.com/emergent-inc/coterm/pull/5293")
    }

    @Test func branchEndpointEncodesHeadFilterAndRejectsMalformedSlugs() throws {
        let endpoint = try #require(
            PullRequestProbeService.branchEndpoint(repoSlug: "emergent-inc/coterm", branch: "feat/x")
        )
        #expect(endpoint.hasPrefix("repos/emergent-inc/coterm/pulls?"))
