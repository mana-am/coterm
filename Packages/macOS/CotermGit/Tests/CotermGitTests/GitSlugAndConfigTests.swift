...
@Suite struct GitSlugAndConfigTests {
    @Test(arguments: [
        "git@github.com:emergent-inc/coterm.git",
        "ssh://git@github.com/emergent-inc/coterm.git",
        "https://github.com/emergent-inc/coterm.git",
        "http://github.com/emergent-inc/coterm",
        "git://github.com/emergent-inc/coterm.git",
        "https://github.com/emergent-inc/coterm",
    ])
    func parsesGitHubRemoteForms(url: String) {
        #expect(GitMetadataService.githubRepositorySlug(fromRemoteURL: url) == "emergent-inc/coterm")
    }
