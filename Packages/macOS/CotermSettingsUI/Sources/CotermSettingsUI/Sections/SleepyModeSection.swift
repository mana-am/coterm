            ...
            SettingsCard {
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.theme) {
                        Text(String(localized: "sleepyMode.theme.coterm", defaultValue: "coterm")).tag(SleepyTheme.coterm)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.mascot) {
                        Text(String(localized: "sleepyMode.mascot.coterm", defaultValue: "coterm mascot")).tag(SleepyMascot.coterm)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.glow) {
                        ...
                        Text(String(localized: "sleepyMode.glow.coterm", defaultValue: "coterm")).tag(SleepyGlow.coterm)
