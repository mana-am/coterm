...
/// coterm, Terminal Config link, Open Markdown in Coterm Viewer,
...
public struct AppSection: View {
    ...
    public init(
        ...
        _openSupported = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.app.openSupportedFilesInCoterm))
        _openMarkdown = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.app.openMarkdownInCotermViewer))
    ...
    private var globalFontMagnificationSubtitle: String {
        ...
        return String(
            ...
            defaultValue: "Scale every font in Coterm by the same percentage. 100% = design size."
        )
    }
        ...
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                subtitle: languageAtAppear != nil && language.current != languageAtAppear
                    ? String(localized: "settings.app.language.restartSubtitle", defaultValue: "Restart coterm to apply")
                    : nil,
            ...
            SettingsCardRow(
                ...
                subtitle: firstClick.current
                    ? String(localized: "settings.app.paneFirstClickFocus.subtitleOn", defaultValue: "When coterm is inactive, clicking a pane activates the window and focuses that pane in one click.")
                    : String(localized: "settings.app.paneFirstClickFocus.subtitleOff", defaultValue: "When coterm is inactive, the first click only activates the window. Click again to focus the pane.")
            ) {
            ...
            // Open Supported Files in Coterm
            SettingsCardRow(
                configurationReview: .json("app.openSupportedFilesInCoterm"),
                String(localized: "settings.app.openSupportedFilesInCoterm", defaultValue: "Open Supported Files in Coterm"),
                subtitle: String(localized: "settings.app.openSupportedFilesInCoterm.subtitle", defaultValue: "Cmd-clicking readable files opens text, code, PDFs, images, audio, video, and Quick Look previews in Coterm.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.configWindow.subtitle", defaultValue: "Open terminal config for non-color settings. Terminal colors are fixed to Anysphere Dark."),
                controlWidth: Self.columnWidth
            ) {
            ...
            // Open Markdown in Coterm Viewer
            SettingsCardRow(
                configurationReview: .json("app.openMarkdownInCotermViewer"),
                String(localized: "settings.app.openMarkdownInCotermViewer", defaultValue: "Open Markdown in Coterm Viewer"),
                subtitle: String(localized: "settings.app.openMarkdownInCotermViewer.subtitle", defaultValue: "When supported file routing is on, Cmd-clicking Markdown files opens the rendered Coterm markdown viewer instead of the generic file preview.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.menuBarOnly.subtitle", defaultValue: "Hide the Dock icon and Cmd+Tab entry. Use the menu bar item to show coterm.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.app.showInMenuBar.subtitle", defaultValue: "Keep coterm in the menu bar for unread notifications and quick actions.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.notifications.paneFlash.subtitle", defaultValue: "Briefly flash a blue outline when coterm highlights a pane.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: String(localized: "settings.notifications.command.subtitle", defaultValue: "Run a shell command when a notification arrives. $COTERM_NOTIFICATION_TITLE, $COTERM_NOTIFICATION_SUBTITLE, $COTERM_NOTIFICATION_BODY are set.")
            ) {
                TextField(
            ...
            SettingsCardRow(
                ...
                subtitle: (telemetryAtAppear != nil && telemetry.current != telemetryAtAppear)
                    ...
                    : String(localized: "settings.app.telemetry.subtitle", defaultValue: "Share anonymized crash and usage data to help improve coterm.")
            ) {
    ...
    /// Standard macOS notification sound names plus Coterm-specific
