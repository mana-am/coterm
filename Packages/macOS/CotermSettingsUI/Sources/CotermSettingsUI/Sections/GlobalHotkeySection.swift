        ...
        SettingsCard {
            SettingsCardRow(
                ...
                subtitle: enabled.current
                    ? String(localized: "settings.globalHotkey.enable.subtitleOn", defaultValue: "Press the shortcut from any app to show or hide all coterm windows.")
                    : String(localized: "settings.globalHotkey.enable.subtitleOff", defaultValue: "Turn this on to show or hide all coterm windows from any app.")
            ) {
