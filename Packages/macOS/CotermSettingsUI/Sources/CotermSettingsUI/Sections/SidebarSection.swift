...
public struct SidebarSection: View {
    ...
    public init(defaultsStore: UserDefaultsSettingsStore, catalog: SettingCatalog, hostActions: SettingsHostActions) {
        ...
        _prLinks = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.sidebar.openPullRequestLinksInCotermBrowser))
        _portLinks = State(initialValue: DefaultsValueModel(store: defaultsStore, key: catalog.sidebar.openPortLinksInCotermBrowser))
    ...
    private var mainCard: some View {
        SettingsCard {
            ...
            SettingsCardRow(
                configurationReview: .json("sidebar.openPullRequestLinksInCotermBrowser"),
                String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in Coterm Browser"),
                subtitle: prLinksSubtitle(prVisible: showPR.current, prClickable: prClickable.current, openInCoterm: prLinks.current)
            ) {
            ...
            SettingsCardRow(
                configurationReview: .json("sidebar.openPortLinksInCotermBrowser"),
                String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in Coterm Browser"),
                subtitle: portLinks.current
                    ? String(localized: "settings.app.openSidebarPortLinks.subtitleOn", defaultValue: "Port clicks open inside Coterm browser.")
    ...
    private func prLinksSubtitle(prVisible: Bool, prClickable: Bool, openInCoterm: Bool) -> String {
        if !prVisible {
        ...
        return openInCoterm
            ? String(localized: "settings.app.openSidebarPRLinks.subtitleOn", defaultValue: "Clicks open inside Coterm browser.")
