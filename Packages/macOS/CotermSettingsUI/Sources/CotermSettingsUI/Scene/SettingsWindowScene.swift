...
/// section's anchor on click. This mirrors what coterm's settings
...
public struct SettingsWindowScene: Scene {
    ...
    public var body: some Scene {
        WindowGroup(String(localized: "settings.title", defaultValue: "Settings"), id: "coterm.settings") {
...
public struct SettingsWindowRoot: View {
    ...
    // sidebar selection changes plus an external app.coterm.settings
    ...
    private var fullSettingsBody: some View {
        ...
        // its declared coterm.json paths to scroll/highlight anchor ids,
    ...
    public static let navigationRequestName = Notification.Name("coterm.settings.navigate")
    ...
    /// Posts a `coterm.settings.navigate` notification with the same
    ...
    /// Navigates from outside (e.g., a `coterm.settings.navigate`
