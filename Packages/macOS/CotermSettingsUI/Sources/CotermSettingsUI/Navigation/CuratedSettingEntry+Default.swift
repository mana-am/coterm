...
extension Array where Element == CuratedSettingEntry {
    /// The coterm-shipped curated search entries.
    ///
    ...
    public static var cotermDefault: [CuratedSettingEntry] {
        [
            ...
            // App
            .init(section: .app, id: "language", title: "Language", synonyms: "app.language locale l10n localization translation english en restart"),
            ...
            .init(section: .app, id: "supported-file-previews", title: "Open Supported Files in Coterm", synonyms: "app.openSupportedFilesInCoterm cmd click file preview pdf image video audio quicklook quick look editor external"),
            .init(section: .app, id: "markdown-viewer", title: "Open Markdown in Coterm Viewer", synonyms: "app.openMarkdownInCotermViewer md markdown mdx viewer preview readme"),
            ...
            .init(
                ...
                detailText: [
                    String(localized: "settings.terminal.memoryGuardrail.subtitleOn", defaultValue: "coterm warns you with a badge and a banner when one pane's process tree uses too much memory, so a single leak can't crash the whole app."),
            ...
            .init(section: .sidebarAppearance, id: "open-pr-links", title: "Open Sidebar PR Links in Coterm Browser", synonyms: "sidebar.openPullRequestLinksInCotermBrowser pr links github browser default external embedded"),
            .init(section: .sidebarAppearance, id: "open-port-links", title: "Open Sidebar Port Links in Coterm Browser", synonyms: "sidebar.openPortLinksInCotermBrowser ports localhost links browser default external embedded"),
            ...
            .init(section: .automation, id: "port-base", title: "Port Base", synonyms: "automation.portBase coterm_port start first base env environment variable"),
            .init(section: .automation, id: "port-range", title: "Port Range Size", synonyms: "automation.portRange coterm_port_end range size count env ports"),

            // Browser
            .init(section: .browser, id: "enable-browser", title: "Enable coterm Browser", synonyms: "browser.disabled enable disable webview embedded browser tabs links"),
            ...
            .init(section: .browser, id: "terminal-links", title: "Open Terminal Links in Coterm Browser", synonyms: "browser.openTerminalLinksInCotermBrowser click url terminal links open in browser href"),
            .init(section: .browser, id: "intercept-open", title: "Intercept open http(s) in Terminal", synonyms: "browser.interceptTerminalOpenCommandInCotermBrowser open command http https url terminal intercept"),
            ...
            .init(
                ...
                synonyms: [
                    "shortcuts.bindings hotkeys keybindings key bindings commands keyboard accelerators chords coterm json open diff viewer changes review git unstaged split left split right split up split down new pane new split move surface move tab focus pane resize pane close tab close workspace next previous select workspace",
            ...
            .init(section: .keyboardShortcuts, id: "shortcut-chords", title: "Shortcut Chords", synonyms: "tmux prefix ctrl-b control-b multi key sequence chord coterm json"),
            ...
            // coterm.json
            .init(section: .settingsJSON, id: "open-file", title: "User config file", synonyms: "open config file json jsonc config editor ~/.config coterm preferences"),
            .init(section: .settingsJSON, id: "documentation", title: "Documentation", synonyms: "docs documentation schema reference coterm json keys configuration"),
