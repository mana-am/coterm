...
public struct SettingsSearchIndex: Sendable {
    ...
    /// Maps a dotted coterm.json path (e.g. `sidebar.showBranchDirectory`)
    ...
    /// Resolves a dotted coterm.json path to the curated entry id the
    ...
    ///
    /// - Parameter path: A dotted coterm.json path, e.g. `terminal.copyOnSelect`.
