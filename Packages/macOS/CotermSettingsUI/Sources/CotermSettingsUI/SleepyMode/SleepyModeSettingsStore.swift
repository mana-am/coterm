...
///
/// This (and `SleepyModeConfig` / the theme enums) lives in CotermSettingsUI by
/// design: Sleepy Mode appearance is user *settings*, and CotermSettingsUI is
/// coterm's settings-model module — it already houses the other persisted settings
