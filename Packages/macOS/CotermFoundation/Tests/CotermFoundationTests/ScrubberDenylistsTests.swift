...
@Suite struct ScrubberDenylistsTests {
    ...
    static let sensitiveKeys: [String] = [
        ...
        "_xsrf", "XSRF-TOKEN",
        // PII (coterm runs sendDefaultPii = false)
    ...
    /// representative secrets/PII (relay `@common` corpora plus coterm's own); each
    ...
    static let valueRedactions: [(input: String, expected: String)] = [
        ...
        // @urlauth equivalent (coterm redactURLCredentials) — userinfo stripped.
        ...
        // coterm-original provider key / JWT / AWS (exceed relay).
    ...
    /// inversion: relay redacts group 1 = body, coterm redacts the whole match).
    ...
    static let preservedStrings: [String] = [
        // UUIDs coterm logs constantly (workspace/surface ids). @uuid intentionally not ported.
        ...
        "coterm DEV build 1234567890 v2",
