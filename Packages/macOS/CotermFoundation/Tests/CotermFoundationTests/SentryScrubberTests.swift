...
@Suite struct SentryScrubberTests {
    ...
    @Test func redactsInjectedHomeDirectory() {
        #expect(
            scrubber.scrub("loaded /Users/lawrence/.config/coterm/coterm.json")
                == "loaded /Users/<redacted>/.config/coterm/coterm.json"
        )
    }
    ...
    @Test func redactsAnyUsersPathEvenWhenNotTheRuntimeHome() {
        ...
        #expect(
            scrubber.scrub("/Users/buildbot/work/coterm/Sources/AppDelegate.swift")
                == "/Users/<redacted>/work/coterm/Sources/AppDelegate.swift"
        )
    }

    @Test func redactsLinuxHomePaths() {
        #expect(
            scrubber.scrub("at /home/runner/coterm/main.swift line 12")
                == "at /home/<redacted>/coterm/main.swift line 12"
        )
    }
    ...
    @Test func leavesSystemPathsUntouched() {
        let input = "/usr/lib/foo /System/Library/bar /Applications/coterm.app"
    ...
    @Test func redactsEmailAddresses() {
        #expect(
            scrubber.scrub("signed in as lawrence@coterm.cc today")
    ...
    @Test func scrubsNestedDictionaryValues() {
        let input: [String: Any] = [
            "cwd": "/Users/lawrence/dev/coterm",
            "email": "lawrence@coterm.cc",
            "count": 7,
            "nested": ["url": "https://x.com/?token=abcdef0123456789secret"] as [String: Any],
        ]
        let output = scrubber.scrub(dictionary: input)
        #expect(output["cwd"] as? String == "/Users/<redacted>/dev/coterm")
    ...
    @Test func combinedSecretEmailAndPathInOneString() {
        let input = "user lawrence@coterm.cc opened /Users/lawrence/secret.txt with token=abcdef0123456789zz"
        #expect(
