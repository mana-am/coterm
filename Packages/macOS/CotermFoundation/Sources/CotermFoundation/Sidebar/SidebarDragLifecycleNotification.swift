...
public struct SidebarDragLifecycleNotification {
    ...
    public static let stateDidChange = Notification.Name("coterm.sidebarDragStateDidChange")
    /// Posted to request that any in-flight sidebar drag state be cleared.
    public static let requestClear = Notification.Name("coterm.sidebarDragRequestClear")
