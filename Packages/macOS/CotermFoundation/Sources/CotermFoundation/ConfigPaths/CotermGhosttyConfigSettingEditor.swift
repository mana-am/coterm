...
/// Reads and writes coterm's numeric Ghostty config settings (sidebar and
...
public struct CotermGhosttyConfigSettingEditor {
    ...
    /// The smallest sidebar font size coterm allows.
    public static let minSidebarFontSize = 10.0
    /// The largest sidebar font size coterm allows.
    ...
    /// The smallest surface-tab-bar font size coterm allows.
    public static let minSurfaceTabBarFontSize = 8.0
    /// The largest surface-tab-bar font size coterm allows.
