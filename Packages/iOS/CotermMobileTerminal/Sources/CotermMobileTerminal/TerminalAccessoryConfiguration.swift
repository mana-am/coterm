...
public final class TerminalAccessoryConfiguration {
    ...
    public static let didChangeNotification = Notification.Name("coterm.terminal.accessoryConfigurationDidChange")
    ...
    private static let orderDefaultsKey = "coterm.terminal.toolbar.order.v3"
    private static let enabledDefaultsKey = "coterm.terminal.toolbar.enabled.v3"
    // Custom actions are schema-stable across v2 and v3, so the v2 key is reused.
    private static let customDefaultsKey = "coterm.terminal.toolbar.custom.v2"
    ...
    private static let legacyV2OrderDefaultsKey = "coterm.terminal.toolbar.order.v2"
    private static let legacyV2EnabledDefaultsKey = "coterm.terminal.toolbar.enabled.v2"
    // v1 schema (parallel [Int] arrays of built-in rawValues), read once to
    // forward-migrate an upgrading user's existing arrangement.
    private static let legacyV1OrderDefaultsKey = "coterm.terminal.accessory.displayOrder.v1"
    private static let legacyV1EnabledDefaultsKey = "coterm.terminal.accessory.enabled.v1"
