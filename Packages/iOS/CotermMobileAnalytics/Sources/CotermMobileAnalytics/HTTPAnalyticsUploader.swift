...
private let analyticsUploadLog = Logger(subsystem: "dev.coterm.ios", category: "analytics-upload")

/// An ``AnalyticsUploading`` that POSTs batches to the coterm web analytics proxy.
///
...
public struct HTTPAnalyticsUploader: AnalyticsUploading {
    ...
    ///
    /// - Parameters:
    ///   - apiBaseURL: The coterm web API base URL, no trailing slash (resolved at
