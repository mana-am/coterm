...
private let pairedMacStoreLog = Logger(subsystem: "coterm.com.emergent.app", category: "PairedMacStore")
...
public actor MobilePairedMacStore: MobilePairedMacStoring {
    ...
    /// - Returns: The `paired-macs.sqlite3` URL under Application Support/coterm.
