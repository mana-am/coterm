...
@Suite struct IOSBuildScopedPairedMacStoreTests {
    ...
    @Test func currentScopePrefersInstalledBundleSuffix() {
        #expect(MobileIOSBuildScope.current(infoDictionary: ["CotermDevTag": "feat"], bundleIdentifier: "dev.coterm.ios.other")?.value == "other")
        #expect(MobileIOSBuildScope.current(infoDictionary: ["CotermDevTag": ""], bundleIdentifier: "dev.coterm.ios.agent")?.value == "agent")
        #expect(MobileIOSBuildScope.current(infoDictionary: ["CotermDevTag": ""], bundleIdentifier: "dev.coterm.ios") == nil)
