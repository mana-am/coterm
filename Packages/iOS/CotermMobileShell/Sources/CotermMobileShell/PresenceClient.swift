...
///
/// This is the typed client for the coterm device presence service
/// (`workers/presence`), the realtime online/offline layer over the durable
/// device registry, and the seam for the iOS device tree
/// (https://github.com/emergent-inc/coterm/pull/5648): the tree renders the
...
/// plus optional `X-Coterm-Team-Id`, with tokens supplied through
/// ``PresenceTokenSource``.
///
...
public actor PresenceClient {
    ...
    ///     the deployed coterm-presence worker URL.
