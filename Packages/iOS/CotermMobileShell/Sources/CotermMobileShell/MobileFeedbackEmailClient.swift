...
/// Default ``MobileFeedbackEmailSubmitting`` that POSTs to the coterm web
...
public struct MobileFeedbackEmailClient: MobileFeedbackEmailSubmitting {
    ...
    /// - Parameters:
    ///   - apiBaseURL: The coterm web API base URL with no trailing slash (e.g.
    ///     `https://coterm.cc`). `/api/feedback` is appended.
