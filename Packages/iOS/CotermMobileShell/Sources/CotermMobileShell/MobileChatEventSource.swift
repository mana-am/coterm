...
/// The iOS implementation of ``CotermAgentChat/ChatEventSource``: adapts the
...
/// ``CotermAgentChat/ChatConversationStore`` resubscribes through its `run()`
/// loop.
public actor MobileChatEventSource: ChatEventSource {
    ...
    ///
    /// Not part of ``CotermAgentChat/ChatEventSource`` (which is scoped to one
