...
struct WorkspaceDetailView: View {
    ...
    /// treating terminal mode as "no GUI data loaded."
    ...
    private func copyDebugLogsFromMenu() {
        ...
        Task { @MainActor in
            ...
            NSLog("coterm.terminal copied %d debug log lines + visible terminal to pasteboard", count)
        }
    }
    #endif
    ...
    private var feedbackComposerExplanation: String {
        ...
        return L10n.string(
            ...
            defaultValue: "Emails your feedback to the Coterm team, stamped with your app version and device."
        )
    }
