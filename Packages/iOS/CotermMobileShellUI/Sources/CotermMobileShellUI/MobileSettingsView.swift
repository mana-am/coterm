...
/// can confirm which coterm account this device uses — the account must match the
...
struct MobileSettingsView: View {
    ...
    var store: CotermMobileShellStore?
            ...
            Form {
                Section {
                    ...
                    Text(L10n.string(
                        ...
                        defaultValue: "This device must be signed in to the same coterm account as the computer you pair with."
                    ))
                }
