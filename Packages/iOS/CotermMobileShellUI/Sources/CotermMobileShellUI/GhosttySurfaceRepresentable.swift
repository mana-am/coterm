...
struct GhosttySurfaceRepresentable: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, GhosttySurfaceViewDelegate {
        let surfaceID: String
        weak var store: CotermMobileShellStore?
        ...
        init(surfaceID: String, store: CotermMobileShellStore) {
        ...
        @MainActor
        private func makeComposerController(store: CotermMobileShellStore) -> UIHostingController<TerminalComposerView> {
