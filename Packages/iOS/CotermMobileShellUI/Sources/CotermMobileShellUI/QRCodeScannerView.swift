...
#if os(iOS)
/// SwiftUI host for the ``CotermMobileCamera`` QR-capture controller.
///
/// Owns one ``QRCodeScanStream`` per presentation, mounts the package's
/// ``QRCodeCaptureController``, and forwards accepted `coterm-ios://` codes to
