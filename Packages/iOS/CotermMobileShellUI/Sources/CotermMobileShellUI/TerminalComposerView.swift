...
struct TerminalComposerView: View {
    ...
    init(store: CotermMobileShellStore, terminalID: String, requestHeightRemeasure: @escaping () -> Void) {
        self.store = store
    ...
    private nonisolated static let maxImageBytes = CotermMobileShellStore.maxPendingAttachmentImageBytes
    ...
    private static let maxAttachmentCount = CotermMobileShellStore.maxPendingAttachmentCount
    ...
    private static let maxTotalAttachmentBytes = CotermMobileShellStore.maxPendingAttachmentTotalBytes
    ...
    static var transferRepresentation: some TransferRepresentation {
        FileRepresentation(contentType: .image) { imported in
            ...
            let destination = FileManager.default.temporaryDirectory
                .appendingPathComponent("coterm-composer-import-" + name)
