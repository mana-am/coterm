...
public final class MobileDisplaySettings {
    ...
    private static let wrapWorkspaceTitlesKey = "coterm.mobile.wrapWorkspaceTitles"
    private static let workspacePreviewLineCountKey = "coterm.mobile.workspacePreviewLineCount"
    private static let unreadIndicatorLeftShiftKey = "coterm.mobile.debug.unreadIndicatorLeftShift.v2"
    private static let profilePictureLeftShiftKey = "coterm.mobile.debug.profilePictureLeftShift"
    private static let profilePictureSizeKey = "coterm.mobile.debug.profilePictureSize"
