...
@Suite struct MobileDisplaySettingsTests {
    ...
    @Test func previewLineCountDefaultsToTwoWithoutAWrite() throws {
        ...
        #expect(defaults.object(forKey: "coterm.mobile.workspacePreviewLineCount") == nil)
    }
    ...
    @Test func previewLineCountClampsToSupportedRange() throws {
        ...
        defaults.set(-5, forKey: "coterm.mobile.workspacePreviewLineCount")
        #expect(MobileDisplaySettings(defaults: defaults).workspacePreviewLineCount == 1)
    }
    ...
    @Test func debugLayoutSettingsDefaultWithoutAWrite() throws {
        ...
        #expect(defaults.object(forKey: "coterm.mobile.debug.unreadIndicatorLeftShift.v2") == nil)
        #expect(defaults.object(forKey: "coterm.mobile.debug.profilePictureLeftShift") == nil)
        #expect(defaults.object(forKey: "coterm.mobile.debug.profilePictureSize") == nil)
    }
    ...
    @Test func debugLayoutSettingsClampToSupportedRanges() throws {
        ...
        defaults.set(-5.0, forKey: "coterm.mobile.debug.unreadIndicatorLeftShift.v2")
        defaults.set(99.0, forKey: "coterm.mobile.debug.profilePictureLeftShift")
        defaults.set(1.0, forKey: "coterm.mobile.debug.profilePictureSize")
        let reloaded = MobileDisplaySettings(defaults: defaults)
