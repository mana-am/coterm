...
public struct LastPromptSidebar: CotermSidebarProvider {
    public let descriptor = CotermSidebarProviderDescriptor(
        id: "com.example.coterm.sidebar.last-prompt",
    ...
    private func promptSubtitle(_ workspace: CotermSidebarProviderWorkspace) -> CotermSidebarProviderText? {
    ...
    private func promptTrailingText(_ workspace: CotermSidebarProviderWorkspace) -> CotermSidebarProviderText? {
