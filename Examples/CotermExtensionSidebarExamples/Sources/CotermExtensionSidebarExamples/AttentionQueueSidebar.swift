...
public struct AttentionQueueSidebar: CotermSidebarProvider {
    public let descriptor = CotermSidebarProviderDescriptor(
        id: "com.example.coterm.sidebar.attention-queue",
    ...
    private func needsAttention(_ workspace: CotermSidebarProviderWorkspace) -> Bool {
    ...
    private func rowSubtitle(_ workspace: CotermSidebarProviderWorkspace) -> CotermSidebarProviderText? {
    ...
    private func hasRemoteTarget(_ workspace: CotermSidebarProviderWorkspace) -> Bool {
