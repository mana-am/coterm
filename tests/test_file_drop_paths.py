...
def wait_for_text(client: coterm, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "coterm drop [image] #1 (a).png").resolve()
    p2 = (tmp / "coterm drop second & file!.jpg").resolve()
